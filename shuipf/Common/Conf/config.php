...
return array(
    ...
    'APP_SUB_DOMAIN_RULES' => array(
        // 'taiyuan' =>['/Pubservice','area=25110000'],
        // 'datong'  =>['/Pubservice','area=25070000'],
        // 'shuozhou'=>['/Pubservice','area=25020000'],
        // 'xinzhou' =>['/Pubservice','area=25090000'],
        // 'lvliang' =>['/Pubservice','area=25060000'],
        // 'jinzhong'=>['/Pubservice','area=25030000'],
        // 'yangquan'=>['/Pubservice','area=25050000'],
        // 'changzhi'=>['/Pubservice','area=25080000'],
        // 'jincheng'=>['/Pubservice','area=25010000'],
        // 'linfen'  =>['/Pubservice','area=25100000'],
        // 'yuncheng'=>['/Pubservice','area=25040000'],
        // 'member'=>'Member',
    ), // 子域名部署规则
    ...
    'DEFAULT_MODULE' => 'Pubservice', // 默认模块
    ...
    /* 优酷上传视频 */
    "YOUKU_CLIENT_ID" => "85f998e7451b8cd9",
    "YOUKU_ACCESS_TOKEN" => "c0d348335fba479043ace0ba9e45b02f",

    /* Elasctisearch配置 */
    "ELK_HOSTS" => ["localhost:9200"],
    "ELK_INDEX" => "es-culture",
    //最新推荐的动态链接
    // "CU_ID"=>"http://47.92.71.11:8082/index.php/Home/Goods/",
    "CU_ID"=>"http://www.sx-cc.com/Industry/Shop/index/",
    //图书馆WDSL接口
    "SX_LIB_API_WSDL_URL"=>"http://opac.lib.sx.cn/opac/webservice/readerWebservice?wsdl",
);