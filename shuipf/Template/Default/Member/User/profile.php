          ...
          <div id="modifyProfile" class="profile"  <if condition="$type neq 'profile' ">style="display: none;"</if>>
            ...
            <ul>
              <li>
                ...
                <label style="width:190px;font-size:16px;">{$userinfo.username}</label> 
              </li>
              <li>
              ...
              <li>
                ...
                <div class="input92cc"><input id="rmobile" class="  input" type="text" value="{$userinfo.mobile}" name="mobile" style="width:190px;"></div>
                <div id="mmobile" class="input_msg"></div>
              </li>
              <li>
              ...
              <li><div class="name">性　　别：</div>
                  ...
                  <select id="rsex" class="select_normal" name="sex" style="width:70px;">
                      ...
                      <option <if condition="$userinfo['sex'] eq 1 ">selected="selected"</if> value="1">男</option>
                      <option <if condition="$userinfo['sex'] eq 2 ">selected="selected"</if> value="2">女</option>
                  </select>
                  </div>
              </li>
