    ...
    <volist name="data" id="vo">
        ...
        <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right">
            <div class=" am-u-sm-8 am-list-main">
                <h3 class="am-list-item-hd"><a href="{:U('detail',['id'=>$vo['id']])}" class="" title="{$vo['content_title']}">{$vo['content_title']}</a></h3>
                <div class="am-list-item-text"><?php echo  mb_strcut(strip_tags($vo['abstract']),0,150)?>...</div>
            </div>
        ...
        <li class="am-g am-list-item-desced">
            <div class="am-u-sm-12 am-list-main">
                <h3 class="am-list-item-hd"><a href="{:U('detail',['id'=>$vo['id']])}" class="">{$vo['content_title']}</a></h3>
