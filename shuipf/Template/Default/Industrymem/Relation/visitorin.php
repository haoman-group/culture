  ...
  <div class="user_center">
    ...
    <div class="user_main">
      <div class="uMain_content">
        ...
        <div class="main_nav2">
          <ul>
            <li class="current"> <a href="{:U('Relation/visitorin')}">谁看过我</a> </li>
            <li> <a href="{:U('Relation/visitorout')}">我看过谁</a> </li>
          </ul>
        ...
        <div class="minHeight500"> 
          ...
          <div class="relation_userlist">
            ...
            <div class="nothing">暂时还没有访问用户-__,-!</div>
            </if>
            <ul>
              ...
              <li>
                ...
                <ul class="info">
                  <li> <a  class="<if condition=" $vo['isonline'] ">online_icon</if> user_card" target="_blank" href="{:UM('Home/index',array('userid'=>$vo['userid']))}" uid="{$vo.userid}">{$vo.username}</a> </li>
