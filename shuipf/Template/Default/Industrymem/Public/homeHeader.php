...
<div class="header">
  <div class="h_main">
    ...
    <ul class="member_login" id="userLogin">
      <li> <a href="{:UM('Home/index',array('userid'=>$uid))}"  title="个人主页"> <img src="{:U('Api/Avatar/index',array('uid'=>$uid,'size'=>45))}" onerror="this.src='{$model_extresdir}images/noavatar.jpg'" id="userInfo"> </a> </li>
      ...
      <li> <a class="icon inform" href="{:U('Message/notification')}"  title="通知">通知</a> <span id="msgTips" class="msg_tips" title="您有新的消息!" style="display: none;"> </span> </li>
      ...
      <li> <a class= "set_menu icon set" href="javascript:;" title="个人设置">个人设置</a>
        <div class="m_set_list menu" style="display: none;"> 
            ...
            <a class="list"  href="{:UM('Home/skin')}"> <b class="skin"></b>空间换肤 </a> 
    ...
    <form id="searchForm" onSubmit="searchDance.init();return false;" >
      <div class="serach right">
        <div class="seh_list"> <a class="seh_list_a" href="javascript:;" id="searchType" sid="1"> 信息 <b class="arrow"></b> </a>
          <div class="seh_sort" style="display: none;"> <a href="javascript:;">信息</a> <a href="javascript:;">会员</a> </div>
        </div>
        <div class="seh_m">
