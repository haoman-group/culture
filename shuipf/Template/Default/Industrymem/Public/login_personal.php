            ...
            <form action="{:U('Public/doLogin')}" id="form" method="post">
                ...
                <dl style="width: 540px;border: 1px solid #ccc;float: none;margin: 0 auto;padding: 20px 55px 20px 55px;">
                	<div style="font-size: 16px;width: 430px;height: 25px;">
                		<div style="width: 215px;float: left;text-align: right;padding-right: 50px;"><input type="radio" name="radio" id="" value="个人登录" checked="" style="width: 15px;height: 15px;margin-right: 10px;margin-top: 10px;"/>个人登录</div>
                    ...
                    <dd class="wj" style="border: none;margin-left: 0;">
                    	...
                    	<div style="line-height: 20px;margin-left: 110px;">
                    		...
                    		<a href="{:U('Industrymem/Index/register')}" style="color: #900;">个人注册，</a>
                        	<a href="{:U('Industrymem/Index/register',['company'=>1])}" style="color: #900;">企业注册</a>
                    	</div>
