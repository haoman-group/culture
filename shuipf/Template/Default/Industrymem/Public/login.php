        ...
        <div class="site">
          ...
          <div class="info_list">
            ...
            <div class="vcode">
              ...
              <div class="reloadCode"> <a id="changeAuthCode" href="javascript:;" style="color:#900;">看不清？换一张</a> </div>
            </div>
          </div>
          </if>
          <div class="info_list">
            <div class="right"> <a href="{:U('Industrymem/Index/lostpassword')}">忘记密码?</a> </div>
