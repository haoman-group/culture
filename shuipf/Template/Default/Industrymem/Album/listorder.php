      ...
      <div class="uMain_content">
        ...
        <div class="main_nav2">
          <ul>
			 ...
			 <li class="current"><a href="{:U("Album/listorder")}">重新排序</a></li>
          </ul>
        ...
        <div class="minHeight500">
           ...
           <else/>
          <div class="imageSort">
            <div id="imageSort" class="sortable"> 
            <volist name="album" id="vo">
            <img id="{$vo.id}" class="avatar" src="{$vo.thumb}" uid="{$uid}" height="80" width="80" onerror="jQuery(function(){libs.imageError(this);}, this)"/> 
            </volist>
            </div>
            <div class="sort_button"> <span class="button-main"> <span>
...
<script type="text/javascript"> albumLib.imageSortInit();</script>
</body>
</html>