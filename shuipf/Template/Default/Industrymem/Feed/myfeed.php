      ...
      <switch name="vo.typeid" >
          ...
          <case value="2">
              <div class="feedName">
                  ...
                  <a href="{:UM('Home/index',array('userid'=>$vo['userid']))}" target="_blank" class="user_card" uid="{$vo.userid}">您</a> 更新了动态&nbsp;
                  <span class="createTime">({$vo.datetime|format_date})</span>
              </div>
              <div class="detail">
                  <strong>您</strong> 喜欢了 <a href="{:UM('Home/index',array('userid'=>$params['byuserid']))}" target="_blank" class="user_card" uid="{$params.byuserid}"  style="float:none;margin-left:0">{$params.byusername}</a> 相册编号ID为 {$params.picid} 的照片
          ...
          <case value="4">
              <div class="feedName">
                  ...
                  <a href="{:UM('Home/index',array('userid'=>$vo['userid']))}" target="_blank" class="user_card" uid="{$vo.userid}">您</a> 更新了说说&nbsp;
                  <span class="createTime">({$vo.datetime|format_date})</span>
              </div>
          ...
          <case value="5">
              <div class="feedName">
                  <a href="javascript:;" style="float:left;"><img width="16" height="16" class="feedIcon"  src="{$model_extresdir}images/icon/icon_mini_album.gif" /></a>
                  <a href="{:UM('Home/index',array('userid'=>$vo['userid']))}" target="_blank" class="user_card" uid="{$vo.userid}">您</a> 更新了照片墙&nbsp;
                  <span class="createTime">({$vo.datetime|format_date})</span>
              </div>
              <div class="detail">
               <volist name="params" id="rs">
