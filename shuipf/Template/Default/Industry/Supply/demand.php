...
<div class="industrytop">
  <div class="ggwh_Content" style="margin-top: 25px;">
				<div class="sx">
					...
					<div class="a-box">
            <a href="{:U('demand')}" name="city">山西</a>
            <volist name="area_array" id="aa">
                <if condition="$aa['id'] neq 25120000">
                    <a href="{:U('demand',['area_id'=>$aa['id']])}" name="city">{$aa.name}市</a>
                </if>
            </volist>
					</div>					
				</div>
			<div class="sx">
              ...
              <a  href="{:U('demand',['category'=>$key])}" class="active" name="category">{$ca}</a>
            </volist>
					</div>					
				</div>
			</div>
    ...
    <div class="search">
        <form action="" method="get">
           <input type="hidden" name="g" value="Industry">
            ...
            <input type="hidden" name="a" value="demand">
    ...
    <div class="list">
        <div class="type">
             <a href="{:U('supply')}"><span class="supp" data-type="1" >供应方</span></a>
             <a href="###"><span data-type="2" class="supp  on" >需求方</span></a>
        </div>
        <div class="table">
        
       <table width="100%" cellspacing="0" style="" class="table2">
        <thead>
        ...
        <div class="buttonadd">
         ...
         <div class="addcontent" style="display:none;">
            <form action="{:U('add')}" method="post">
             <input type="hidden" value="demand" name="style">
               <dl>  
                    <dt>供需方:</dt>
                    ...
                    <dd style="margin-top:25px;"><select select  class="attendance_num" name="area_id" id="type">
                    ...
                    <dt></dt><dt style="margin-top:25px;">附件:</dt>
