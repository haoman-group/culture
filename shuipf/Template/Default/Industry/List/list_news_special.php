                        ...
                        <volist name="data" id="vo">
                            <li style="margin-top: 0px;">
                                ...
                                <dl class="clearfix" style="position: relative;padding: 20px;">
                                    ...
                                    <dt><a href="{:U('Industry/Index/shows',array('catid'=>$catid,'id'=>$vo['id']))}"><img src="{:thumb($vo['thumb'],330,195,1)}" alt="" style="width:330px;height:195px"></a></dt>
                                    <dd>
                                        <h1 style="margin: 0 0 10px;">{$vo.keywords}</h1>

                                        <p>{$vo.description}</p>
                                        <a href="{:U('Industry/Index/shows',array('id'=>$vo['id'],'catid'=>$_GET['catid']))}" style="position: absolute;bottom: 20px;right: 20px;">更多>></a>
                                    </dd>
                                </dl>
                            </li>
