			...
			<div class="content_consume">
				<div class="content_main consume_hot">
					...
					<div class="content_main_list">
						...
						<ul class="clearfix">
							...
							<li><a href="{:U('Content/Index/shows',array('catid'=>$catid,'id'=>$vo['id']))}"><em>●</em>{$vo.title|str_cut=###,22}</a></li>
							</volist>
						</ul>
						</content>	
				...
				<div class="content_main other_message">
					...
					<div class="content_main_list">
						...
						<ul class="clearfix">
							<volist name="data" id="vo">
							<li><a href="{:U('Content/Index/shows',array('catid'=>$catid,'id'=>$vo['id']))}"><em>●</em>{$vo.title|str_cut=###,20}</a></li>
							</volist>
						</ul>
						</content>	
