            ...
            <div class="notis localdynamic clearfix">
                <div class="left notis-left" style="width: 766px;">
                    <div class="special_content_left newsbox">
                            ...
                            <h2 class="hotspot-title" style="color: #900;"><span>|&nbsp;我的创意</span></h2>
                            <ul class="local">
                                <volist name="data" id="vo">
                                    <li><a href=".{$vo.url}"><em>●</em>{$vo.title|str_cut=###,40}</a><span>{$vo.addtime}</span></li>
                                </volist>
                            </ul>
                ...
                <div class="right notis-right">
                    <div class="newsbox">
                        ...
                        <ul class="rtrankul">
                                ...
                                <volist name = "info" id = "wo">
                                    <if condition = "($i lt 4)">
                                        <li class="on"><span>{$i}</span><a href="{:U('show',array('id'=>wo['id']))}" style="color:#696b76; ">{$wo.title|str_cut=###,23,''}</a></li>
                                        <else />
                                        <li><span style="background: #C9C9C9">{$i}</span><a href="{:U('show',array('id'=>wo['id']))}" style="color:#696b76;" >{$wo.title|str_cut=###,23,''}</a></li>
                                    </if>
                                </volist>
