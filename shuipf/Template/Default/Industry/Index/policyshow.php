    ...
    <div id="nav" class="hotspot-nav">
        <div class="container">
            <ul>
                ...
                <li><a href="###">政策法规</a></li>
                <li><span>></span></li>
                <li><a href="{:U('policylist',array('cid'=>$category['cid']))}" style="color: #900;">{$category['name']} </a></li>
<!--                <li><span>></span></li>-->
            ...
            <div class="hotspot-left">
		                ...
		                <div class = "left_div">
		                    <div class="left_content_title">
		                                ...
		                                <h2>{$data.publish_name}</h2>
		                                <p>{$data['addtime']} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp发布机构:{$data['publish_agency']}</p>
		                    </div>
		                    <div class="left_content_div"><if condition="$data['publish_content'] neq '' ">{$data['publish_content']}<else/>{$contents}</if></div>
            ...
            <div class="hotspot-right right  notis-right article-right">
                ...
                <ul style="padding-top: 20px;padding-bottom: 15px;">
                        ...
                        <volist name="about" id="vo">
                            <if condition="$i lt 4">
                                <li class="on"><span style="margin-right: 16px;">{$i}</span><a href="{:U("Industry/Index/policyshow",array('id'=>$vo['id']))}" style="font-size: 16px;color: #696b76;">{$vo.publish_name|str_cut=###,10}</a><p style="float:right;padding-right: 15px;">{$vo['addtime']}</p></li>
                                <else/>
                                <li><span style="margin-right: 16px;">{$i}</span><a href="{:U("Industry/Index/policyshow",array('id'=>$vo['id']))}" style="font-size: 16px;color: #696b76;">{$vo.publish_name|str_cut=###,10}</a><p style="float:right;padding-right: 15px;">{$vo['addtime']}</p></li>
                            </if>
                        </volist>
