            ...
            <div class="hotspot-right right  notis-right article-right">
                ...
                <ul style="padding-top: 20px;padding-bottom: 15px;">
                    <content action="hits" catid="$catid" order="weekviews DESC" num="10">
                        <volist name="data" id="vo">
                            <if condition="$i lt 4">
                                <li class="on"><span style="margin-right: 16px;">{$i}</span><a href=".{$vo.url}" style="font-size: 16px;color: #696b76;">{$vo.title|str_cut=###,15}</a><p style="float:right;padding-right: 15px;background: url('{$config_siteurl}statics/ci/images/sheng.png') no-repeat 42px 8px;">13213</p></li>
                                <else/>
                                <li><span style="margin-right: 16px;">{$i}</span><a href=".{$vo.url}" style="font-size: 16px;color: #696b76;">{$vo.title|str_cut=###,15}</a><p style="float:right;padding-right: 15px;background: url('{$config_siteurl}statics/ci/images/sheng.png') no-repeat 42px 8px;">13213</p></li>
                            </if>
                        </volist>
                    </content>
                </ul>
