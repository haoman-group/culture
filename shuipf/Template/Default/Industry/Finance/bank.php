<extend name="shuipf/Template/Default/Industry/common/_layout.php" /><block name="after_styles">
...
<div id="nav">
		<div class="container">
				<ul>
					...
					<li><span>></span></li>
					<li>
						<a href="javascript:;" style="color: #900;">文化银行</a>
					</li>
				</ul>
			</div>
		</div>
		<div id="content">
			<div class="container clearfix">
				<div class="lianmeng">
					<h5 style="background: #e2ebf2;border-left: none;color: #900;height: 52px;font-size: 20px;padding-left: 20px;line-height: 52px;"><b>|</b>&nbsp;&nbsp;文化银行</h5>
					<ul class="clearfix ul_border">
					<get table="links" termsid="2" visible="1" order="id DESC" num="16" page="$page">
						<volist name="data" id='vo'>
							<li>
								<a href="http://www.spdb.com.cn/" class="fund">
