        ...
        <div class="box-with-border">
            ...
            <div class="register">
                ...
                <dl class="clearfix">
                    ...
                    <dt><i>*</i>确认密码：</dt><dd><input type="password" name="password2" value="" style="width: 270px;height: 35px;border: 1px solid #d6d6d6;font-size: 16px;border-radius: 8px;"><span>请再次输入上面的密码</span></dd>
