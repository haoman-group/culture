...
<block name="content">
    <div id="content">
        <div class="box-with-border">
            <form action="{:U('Industry/Public/doRegister')}" method="post" id="form_reg">
                <div class="register">
                    <h2> 个人用户注册</h2>
                    <dl class="clearfix">
                        <dt><i>*</i>用户名：</dt><dd><input type="text" value="" placeholder="" name="username"><span>请输入用户名</span></dd>
                        <dt><i>*</i>邮箱：</dt><dd><input type="text" value="" placeholder="" name="email"><span>请输入邮箱</span></dd>
                        ...
                        <dt><i>*</i>确认密码：</dt><dd><input type="password" value="" name="password2" style="width: 270px;height: 35px;border: 1px solid #d6d6d6;font-size: 16px;border-radius: 8px;"><span>请再次输入上面的密码</span></dd>
                        ...
                        <dt><i>*</i>验证码：</dt><dd><input type="text" name="vCode" value="">
                        <img  src='{:U("Api/Checkcode/index","type=userregister&code_len=4&font_size=14&width=150&height=40&font_color=&background=")}' style="width: 120px;height: 40px;margin-left: 15px;border-radius: 8px;" alt="验证码" id="authCode" />
                        <a href="javascript:;" onclick="changeAuthCode()" style="font-size: 11px;color: #900;background:#ffffff;margin-left:0px;text-align:left;"> 看不清，换一张</a>
                        </dd>
                    </dl>
                </div>
                <div class="agree-div">
