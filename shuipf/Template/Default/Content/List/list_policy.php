    ...
    <div id="nav">
        <div class="container">
            <ul style="float: left;">
                ...
                <li><span>></span></li>
                <li><a href=".{:getCategory(28,'url')}">政策法规</a></li>
                <li><span>></span></li>
                ...
                <ul>
                    ...
                    <!--<content action="category" catid="$parent_catid" order="listorder ASC" >-->
                        <volist name="categorylists" id="v1">
                            <li <eq name="v1[catid]" value="$catid">style="background:#f1f1f1"</eq>><a href="<eq name='v1[child]' value='1'>javascript:<else/>{$v1.url}</eq>" style="color: black;"><span>●</span>{$v1.catname}</a></li>
