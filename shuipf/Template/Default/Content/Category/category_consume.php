            ...
            <article class="cardrt">
                ...
                <div class="cardcell clearfix" style="margin-bottom: 20px;">
                    <div class="consumer tit" style="color: red">
                        ...
                        <a href="{:getCategory(17,'url')}">更多>></a>
                    </div>
                    ...
                    <div class="cardsubrt">
                        <ul class="ulguanzhu">
                            <position action="position" posid="5">
                                <volist name="data" id="vo">
                                    <li>
                                        <a href=".{$vo.data.url}"><em>[{$i}]{$vo.data.id}</em>{$vo.data.title|str_cut=###,16}</a>
                                    </li>
                                </volist>
                            </position>
                        </ul>
                ...
                <div class="cardcell clearfix">
                    ...
                    <div class="consumer tit" style="color: red">
                        ...
                        <a href=".{:getCategory(18,'url')}">更多>></a>
                    </div>
                        ...
                        <div class="cardre clearfix">
                            <content action="lists" catid="18" order="views DESC" num="5" page='$page'>
                                ...
                                <ul>
                                    <volist name="data" id="vo">
                                        <li>
                                            <a href=".{$vo.url}">{$vo.title|str_cut=###,15}</a>
                                        </li>
                                    </volist>
                                </ul>
                            </content>
                            ...
                            <content action="lists" catid="18" order="id desc" num="2" page='$page'>
                                <volist name="data" id="v">
                                    <li>
                                        ...
                                        <p>
                                            <em>[{$i}]</em>
                                            <a href=".{$v.url}}">{$v.title|str_cut=###,35}</a>
                                        </p>
                                    </li>
                                </volist>
                            </content>
                ...
                <div class="cardcell">
                    <div class="consumer tit" style="color: red">
                        ...
                        <a href="{:U('Content/Consume/consume')}">更多>></a>
                    </div>
                    <ul class="ulcardlogos clearfix" style="width: 800px;">
                        ...
                        foreach ($data as $k => $v) {
                            ?>
                            <li>
                                <a href="{:U('Content/Detail/index', array('id'=>$v['id']))}"><img
                                            src="{:thumb($v['photo'],160,45)}"
                                            style="width: 160px;height: 48px;"> </a>
                                <!-- <div class="name"><a href="{:U('Content/Detail/index')}">{$v.name}</a> </div> -->
                            </li>
                            <?php
                        }
                        ?>
