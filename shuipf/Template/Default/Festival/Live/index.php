...
<div class="container-fluid">
    <div class="header">
        <div class="container">
            ...
            <h1 class="logo-text">直播列表详情<span>List details</span></h1>
        </div>
    </div>
    <div class="content">
        <div class="container">
                    ...
                    <li>
                        <dl class="clearfix">
                            ...
                            <dd style="margin-left:20px;">
                               <a  target="_blank" href="{:U('detail',array('id'=>$vo['id']))}"> <h6>{$vo['title']}</h6></a>   
                               <span>直播时间：{$vo.periodical_date}</span>
