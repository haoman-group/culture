...
<div class="container-fluid">
    <div class="header">
        <div class="container">
            ...
            <h1 class="logo-text">演出论坛<span>Event display</span></h1>
        </div>
    </div>
    <div class="content">
        <div class="container">
            <div class="recommend-img1">
            <div class="recommend-txt">
                <h4>{$data['title']}</h4>
                <span style="margin-top:20px;">  {$data['author']} </span> 
            </div>
             <notempty name="data['url']">
            
            <p style="float:right;word-wrap:break-word;"><a href="{$data['url']}" style="color:black;"> 视频链接：{$data['url']}</a></p>
            </br>
            </notempty>
            
            <p style="word-wrap:break-word;">{$data['content']}</p>
            <notempty name="data['photographyer']">
            <span style="margin-top:20px;float:right;"> 单位：{$data['photographyer']}</span>
            </notempty>
            <notempty name="data['intro']">
            </br>
            <p style="margin:30px -240px 20px 0;float:right;word-wrap:break-word;"> 作者：{$data['intro']}</p>
            </notempty>
