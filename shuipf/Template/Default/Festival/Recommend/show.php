...
<div class="container-fluid">
    <div class="header">
        <div class="container">
            ...
            <h1 class="logo-text">活动展示<span>Event display</span></h1>
        </div>
    </div>
    <div class="content">
        <div class="container">
            ...
            <div class="recommend-txt">
                ...
                <span style="margin-top:-27px;"><if condition="$data.start_date neq '0'">活动时间:{$data.start_date|default=""|date="Y-m-d",###}-{$data.end_date||default=""|date="Y-m-d",###} </if> <if condition="$data['site'] neq '' "> 活动地点：{$data['site']} </if> </span>
                
            </div>
            <volist name="data['images']" id="vo">
                <img src="{$vo}" alt="" style="width:700px;margin-top:15px;">
                </volist>
                <p>{$data['editer']}</p>
