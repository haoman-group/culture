        ...
        <div class="container">
            ...
            <div class="recommend-lists">
                ...
                <volist name="data" id="vo">
                    <li>
                        <dl class="clearfix">
                            <dt><a  target="_blank" href="{:U('Recommend/show',array('id'=>$vo['id']))}"><img src="{:thumb($vo['image'],313,188,1)}" alt="" style="width:313px;height:188px;"></a></dt>
                            <dd>
                               <a  target="_blank" href="{:U('Recommend/show',array('id'=>$vo['id']))}"> <h6>{$vo['title']}</h6></a>
                                <p><p style="word-wrap:break-word;text-indent:2em;"><?php echo  mb_strcut(strip_tags($vo['content']),0,225)?></p></p>
                    ...
                    <!--<li>
                        <dl class="clearfix">
                            <dt><a  target="_blank" href="javascript:void(0)"><img src="{$config_siteurl}statics/cu/festival/images/recommend/01.jpg" alt=""></a></dt>
                            <dd>
