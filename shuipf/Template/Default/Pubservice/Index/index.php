	...
	<template file="Pubservice/Common/_head"/>
						...
						<for start="0" end="5">
							<div class="swiper-slide"  align="center">
								<if condition="isset($slideData[$i])">
									<a href="{$slideData[$i]['picture_url']}">
		...
		<!-- swiper 轮播容器 结束-->
			...
			<div class="ggwh_Content" style="padding:20px 0px;">
				<div class="row">
					<div class="col-md-6  col-xs-6 ggwh_SearchRm">
					...
					<div class="col-md-6" style="position: relative;width:360px;float:right;margin-top:8px;">
			...
			<div style="position: fixed; right: 50%; margin-right: -770px; bottom: 0; z-index: 99999;    margin-bottom: 125px; ">
				...
				<ul class="position-video-list">
					...
					<li><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=1544456374&site=www.sx-cc.com&menu=yes"><i class="fa fa-qq" style="margin-right:6px;"></i>QQ客服</a></li>
