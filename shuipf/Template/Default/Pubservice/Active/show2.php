        ...
        <div class="ggwh_Content" style="margin-top: 20px;">
            ...
            <div class="applyContent">
                ...
                <div style="overflow: hidden;">
                    <h2 class="pull-left">{$data.subtitle}</h2><span style="margin-left: 50px;line-height: 80px;">截止人数:{$data.acceptance}/<span class="text-red"><if condition="$data['num'] neq '' ">{$data['num']}<else/>0</if></span></span>
                </div>
                <table class="table applyTable">
                    ...
                    <tr>
                        ...
                        <td>授课教师：<if condition="$data.lecturer eq '' ">待定<else/>{$data.lecturer}</if></td>
                    </tr>
                    <tr>
