    ...
    <div class="ggwh_Content visitRegister">
        <div class="ul_form">
            <ul class="bespeak_tab clearfix">
                <li class="on"><a href="javascript:;">个人</a>
                    <!-- <span>（还能预约199人）</span> -->
                    <if condition="$account eq 0">
                        <span>(预约已满，无法报名)</span>
                        <else/>
                        <span>(还能预约:{$account}人)</span>
                    </if>
                </li>
                <li><a href="javascript:;">团体</a></li>
            </ul>
            <form action="{:U('bespeak')}" method="post" class="J_ajaxForm bespeak_form">
                ...
                <dl>
                    ...
                    <option value="3">3</option>
                     ...
                     <input type="hidden" name="tablename" value="{$_GET['tablename']}">
                      <input type="hidden" name="tab_cid" value="{$_GET['tab_cid']}">
                       ...
                       <input type="hidden" name="stylenum" value="1">
                    <dt>电话</dt>
                    <dd><input type="text" name="tel[]" value="" class="telnum" id="tel"><i>*</i></dd>
                    <dd id="InputsWrapper"></dd>
                    <dt>身份证</dt>
                    <dd><input type="text" name="credential_no[]" value="" class="credential_no_num"><i>*</i></dd>
                    <dd id="credential"></dd>
                    <!--<dt>年龄</dt>
                    ...
                    <dt></dt>
                    <dd><input class="btn btn_submit mr10 J_ajax_submit_btn" type="submit" value="提交预约单"></dd>
                </dl>
                
            </form>
            <form action="{:U('bespeak')}" method="post" class="J_ajaxForm bespeak_form" hidden>
                <input type="hidden" style="opacity: 0; width: 0px;" name="areaid" class="area" value="{$data.area}"/>
                <dl>
                    <dt>团体名称</dt>
                    <dd><input type="text" name="permanent_name"><i>*</i><span style="color: #ccc;margin-left: 10px;">餐馆预约信息[<i>*</i>]为必填</span></dd>
                    <dt>预约参观人数</dt>
                    <dd><input type="text" name="attendance_num"><i>*</i></dd>
                    <dt>电话</dt>
                    <dd><input type="text" name="tel[]"><i>*</i></dd>
                    <dt>身份证</dt>
                    <dd><input type="text" name="credential_no[]" value="" class="credential_no_num"><i>*</i></dd>
                     <input type="hidden" name="tablename" value="{$_GET['tablename']}">
                      <input type="hidden" name="tab_cid" value="{$_GET['tab_cid']}">
                       <input type="hidden" name="area" value="{$_GET['area']}">
                       <input type="hidden" name="userid" value="{$id}">
                       <input type="hidden" name="stylenum" value="2">
                    <!--<dt>年龄</dt>
                     <dd class="hr"><select name="" id=""><?php for($i=16;$i<=70;$i+=6){ ?> <option value="<?php echo $i; ?>----<?php echo $i+5 ?>"><?php echo $i; ?>----<?php echo $i+5 ?></option>  <?php } ?></select><i>*</i><br><span style="color: #f00">注：未成年人和残障人士需在监护人陪同下参观本馆</span></dd>-->
                    <!--<dt>预约参观日期</dt>
                    <dd>
