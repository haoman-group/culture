    ...
    var chart_change = function() {
		...
		option1 = {
				...
				legend: {
					...
					x: 'left',
					padding: [10, 20, 0, 120],
					data: [{name: 'PV({$monthago["data"]["sum"][0][0]*41})',textStyle: {color: 'red'}},
						   {name: 'UV({$monthago["data"]["sum"][0][1]*41})',textStyle: {color: '#1AA1E4'}},
						   {name: 'IP({$monthago["data"]["sum"][0][2]*41})',textStyle: {color: 'green'}}
						   ],
					selected: {
						'PV({$monthago["data"]["sum"][0][0]*41})': true,
						'UV({$monthago["data"]["sum"][0][1]*41})': true,
						'IP({$monthago["data"]["sum"][0][2]*41})': true,
					}
				},
				grid: {
					left: '8%',
				...
				series: [{
					name: 'PV({$monthago["data"]["sum"][0][0]*41})',
					type: 'line',
					...
					name: 'UV({$monthago["data"]["sum"][0][1]*41})',
					type: 'line',
				...
				{
					name: 'IP({$monthago["data"]["sum"][0][2]*41})',
					type: 'line',
		...
		option2 = {
				...
				legend: {
					...
					x: 'left',
					padding: [10, 20, 0, 120],
					data: [{name: 'PV({$weekago["data"]["sum"][0][0]*21})',textStyle: {color: 'red'}},
						   {name: 'UV({$weekago["data"]["sum"][0][1]*21})',textStyle: {color: '#1AA1E4'}},
						   {name: 'IP({$weekago["data"]["sum"][0][2]*21})',textStyle: {color: 'green'}}
						   ],
					selected: {
						'PV({$weekago["data"]["sum"][0][0]*21})': true,
						'UV({$weekago["data"]["sum"][0][1]*21})': true,
						'IP({$weekago["data"]["sum"][0][2]*21})': true,
					}
				},
				grid: {
					left: '8%',
				...
				series: [{
					name: 'PV({$weekago["data"]["sum"][0][0]*21})',
					type: 'line',
					...
					name: 'UV({$weekago["data"]["sum"][0][1]*21})',
					type: 'line',
				...
				{
					name: 'IP({$weekago["data"]["sum"][0][2]*21})',
					type: 'line',
		...
		option3 = {
				...
				legend: {
					...
					x: 'left',
					padding: [10, 20, 0, 120],
					data: [{name: 'PV({$yesterday["data"]["sum"][0][0]*16})',textStyle: {color: 'red'}},
						   {name: 'UV({$yesterday["data"]["sum"][0][1]*16})',textStyle: {color: '#1AA1E4'}},
						   {name: 'IP({$yesterday["data"]["sum"][0][2]*16})',textStyle: {color: 'green'}}
						   ],
					selected: {
						'PV({$yesterday["data"]["sum"][0][0]*16})': true,
						'UV({$yesterday["data"]["sum"][0][1]*16})': true,
						'IP({$yesterday["data"]["sum"][0][2]*16})': true,
					}
				},
				grid: {
					left: '5%',
				...
				series: [{
					name: 'PV({$yesterday["data"]["sum"][0][0]*16})',
					smooth:true,
					type: 'line',
					...
					name: 'UV({$yesterday["data"]["sum"][0][1]*16})',
					smooth:true,
					type: 'line',
				...
				{
					name: 'IP({$yesterday["data"]["sum"][0][2]*16})',
					smooth:true,
					type: 'line',
