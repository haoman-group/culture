...
<div class="all">
  ...
  <div class="ht2"><img src="{$config_siteurl}statics/cu/images/images/sjk/weizhi-bg1.png" width="1350" height="50" /></div>
    ...
    <!-- 代表性项目及代表性传承人 代表性项目 -->
    <if condition="($_GET['cid'] eq 85 and $_GET['represen'] eq 1) or ($_GET['cid'] eq 86 and $_GET['represen'] eq 1) or ($_GET['cid'] eq 87 and $_GET['represen'] eq 1) or ($_GET['cid'] eq 88 and $_GET['represen'] eq 1)or ($_GET['cid'] eq 89 and $_GET['represen'] eq 1)
     or ($_GET['cid'] eq 90 and $_GET['represen'] eq 1)or ($_GET['cid'] eq 91 and $_GET['represen'] eq 1)
    ">
    <div class="search-content-tab"> 
      <table class="table sjkTb">
          ...
          <volist name="lists" id="vo">
            ...
            <td style="text-align:center">代表性项目</td>
    ...
    <div class="search-content-tab"> 
      <table class="table sjkTb">
        ...
        <tbody>
          ...
          <tr>
            <td style="text-align:center">{$vo.id}</td>
            <td style="text-align:center">{$vo.cac_name}</td>
            <td style="text-align:center">{$vo.cac_addr}</td>
            <td style="text-align:center">{$vo.cac_area}</td>
            <td style="text-align:center">{$vo.cac_legalpre}</td>
            <td style="text-align:center">{$vo.dig_website}</td>
            <td style="text-align:center">{$vo.cac_tel}</td>
            <td><a><img src="{$config_siteurl}statics/cu/images/images/sjk/download.png"/></a></td>
            <td><a href="{:U('show',array('id'=>$vo['id']))}"><img style="width: 14px;" src="{$config_siteurl}statics/cu/images/images/sjk/file.png"/></a></td>
            <td><a><img src="{$config_siteurl}statics/cu/images/images/sjk/share.png"></a></td>
          </tr>
