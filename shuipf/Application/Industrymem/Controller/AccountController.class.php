...
class AccountController extends MemberBase {
    ...
    public function authorize() {
        ...
        switch ($type) {
            case 'qq':
                $redirect_uri = cache('Config.siteurl') . "index.php?g=Member&m=Account&a=qqbind";
                header("location:" . $this->connect->getUrlConnectQQ($redirect_uri));
                break;
            case 'sina_weibo':
                $redirect_uri = cache('Config.siteurl') . "index.php?g=Member&m=Account&a=sinabind";
    ...
    public function qqbind() {
        ...
        if ($this->connect->connectAdd(array(
            ...
            $this->error($this->connect->getError());
        }
    }
