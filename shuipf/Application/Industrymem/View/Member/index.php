  ...
  <form name="myform" action="{:U('Member/delete')}" method="post" class="J_ajaxForm">
    ...
    <div class="">
      <div class="btn_wrap_pd">
        <button class="btn  mr10 J_ajax_submit_btn" data-action="{:U('Industrymem/Member/lock')}" type="submit">锁定</button>
        <button class="btn  mr10 J_ajax_submit_btn" data-action="{:U('Industrymem/Member/unlock')}" type="submit">解锁</button>
