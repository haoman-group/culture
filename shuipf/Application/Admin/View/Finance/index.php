...
<div class="nav">
    <ul class="cc">
        <li class="current"><a href="###" >诚信申请</a></li>
        ...
        <volist name="data" id="vo">
          <!--<tr onClick="select_list(this,'{$vo.title}',{:getCategory($vo['catid'],'modelid')},{$vo.id})"  class="cu" title="点击选择">-->
            ...
            <td ><a href="javascript:;;"><span style="" >
              <if condition=" $vo['audit']!=0 ">{$vo.company_name}
                <else/>
                <font color="#FF0000">[未审核]</font> - {$vo.company_name}</if>
              </span></a>
            ...
            <td>
            	<a href="{:U('Admin/Finance/show',array('creditid'=>$vo['id']))}">查看</a>
            	<if condition = "$vo['audit'] == 0">
            		<a href="{:U('Admin/Finance/show',array('creditid'=>$vo['id']))}">审核</a>
            	<else/>
            		已审核
            	</if>
