        ...
        <div class="table_full">
            <form class="J_ajaxForm" action="{:U('add')}" method="post"  >
                ...
                <tr>
                    <th width="147">副标题</th>
                    <td>
                        <input type="text" maxlength="255" class="input length_5" name="deputy_title" value="" required="required">
                    </td>
                </tr>
                <tr>
                    <th width="147">内容</th>
                    <td>
                        <textarea type="text" class="input_txt" name="content" ></textarea>
                    </td>
                </tr>
                 <tr>
                        <th>视频：</th>
               ...
               <tr>
                ...
                <tr>
                    <th width="147">关键词</th>
                    <td>
                        <input type="text" maxlength="500" class="input" name="keywords" value="" >
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="session">
                        <for start="1" end="20">
                            <option value="{$i}">第{$i}届
                            </option>
                        </for>
                        </select>
                        <!-- <input type="text" maxlength="45" class="input" name="session" value="" > -->
                    </td>
                </tr>
                <!-- <tr>
                    <th width="147">类型</th>
                    <td>
                        <input type="text" maxlength="145" class="input" name="type" value="" >
                    </td>
                </tr> -->
                </table>
                <div class="">
