...
<div class="wrap J_check_wrap">
  ...
  <div class="mb10">
        <a href="javascript:void(0)" onClick="javascript:openwinx('{:U("Admin/Product/category_add")}','')" class="btn" title="添加内容"><span class="add"></span>添加内容</a>
      ...
      <table width="100%">
        ...
        <volist name="data" id="vo">
          <tr>
            ...
            <?php
            $op = array();
            $op[] = '<a href="javascript:;;" onClick="javascript:openwinx(\''.U("Admin/Product/category_edit",array("id"=>$vo['id'])).'\',\'\')">修改</a>';
