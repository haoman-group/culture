...
<div class="wrap J_check_wrap">
  ...
  <div class="mb10">
        <a href="javascript:void(0)" onClick="javascript:openwinx('{:U("Admin/Product/brand_add")}','')" class="btn" title="添加内容"><span class="add"></span>添加内容</a>
      ...
      <table width="100%">
        ...
        <volist name="data" id="vo">
          <tr>
            ...
            <td align="center">
            <a href="{:U('Admin/Product/brand_delete',array('bid'=>$vo['bid']))}" class="J_ajax_del">删除</a>
