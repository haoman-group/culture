...
<div class="wrap J_check_wrap">
  <form name="myform" id="myform" action="{:U('Admin/Product/union_active_add')}" method="post" class="J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
    ...
    <div class="table_full">
      <table width="100%">
      	<tr><td>名称</td><td><input type="text" name="active_name"></td></tr>
      	<tr>
        <td>图片</td>
        <td>
