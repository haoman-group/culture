...
<div class="wrap J_check_wrap">
  <form name="myform" id="myform" action="{:U("Admin/Product/type_add")}" method="post" class="J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
    ...
    <div class="table_full">
      <table width="100%">
      	<tr><td>名称</td><td><input type="text" name="typename"></td></tr>
      	<tr>
        <td>所属分类</td>
        <td>
            <volist name='category' id='vo'>
              <input name="cate_id" type="radio" value="{$vo.id}" />{$vo.c_name}
            </volist>
        </td>
        </tr>
      </table>
