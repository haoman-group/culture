        ...
        <volist name="data" id="vo">
          <!--<tr onClick="select_list(this,'{$vo.title}',{:getCategory($vo['catid'],'modelid')},{$vo.id})"  class="cu" title="点击选择">-->
            ...
            <td ><a href="javascript:;;"><span style="" >
              <if condition=" $vo['status']!=0 ">{$vo.p_name}
                <else/>
                <font color="#FF0000">[未审核]</font> - {$vo.p_name}</if>
              </span></a>
            </td>
            ...
            <td>
            	<a href="{:U('Admin/Product/show',array('id'=>$vo['id']))}">查看</a>
            	<if condition = "$vo['status'] == 0">
            		<a href="{:U('Admin/Product/show',array('id'=>$vo['id']))}">审核</a>
            	<else/>
            		已审核
            	</if>
