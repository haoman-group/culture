...
<div class="wrap J_check_wrap">
  <form name="myform" id="myform" action="{:U('Admin/Product/union_active_edit')}" method="post" class="J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
    ...
    <div class="table_full">
      <table width="100%">
      	<tr><td>名称</td><td><input type="text" name="active_name" value="{$data.active_name}"></td></tr>
      	<tr>
        <td>图片</td>
        <td>
        <script type="text/javascript">
          $(function(){
            $('#active_thumb').val("{$data['active_thumb']}");
          })
        </script>
            <Form function="images" parameter="active_thumb,active_thumb,'',content"/>
        </td>
        </tr>
