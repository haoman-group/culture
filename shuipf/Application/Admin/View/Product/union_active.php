...
<div class="wrap J_check_wrap">
  ...
  <div class="mb10">
        <a href="javascript:void(0)" onClick="javascript:openwinx('{:U("Admin/Product/type_add")}','')" class="btn" title="添加内容"><span class="add"></span>添加内容</a>
      ...
      <table width="100%">
        ...
        <volist name="data" id="vo">
          <tr>
            ...
            <td align="center">
             <a href="{:U('Admin/Product/union_active_show',array('id'=>$vo['id']))}" class="">查看</a>
            <a href="{:U('Admin/Product/union_active_edit',array('id'=>$vo['id']))}" class="">编辑</a>
             <a href="{:U('Admin/Product/union_active_del',array('id'=>$vo['id']))}" class="J_ajax_del">删除</a>
            </td>
          </tr>
        </volist>
      </table>
