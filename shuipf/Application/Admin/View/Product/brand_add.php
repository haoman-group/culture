...
<div class="wrap J_check_wrap">
  <form name="myform" id="myform" action="{:U("Admin/Product/brand_add")}" method="post" class="J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
    ...
    <div class="table_full">
      <table width="100%">
      	<tr><td>品牌名称</td><td><input type="text" name="brandname"></td></tr>
      	<tr>
        <td>所属功能</td>
        <td>
            <volist name='typedata' id='vo'>
              <input name="type_id[]" type="checkbox" value="{$vo.tid}" />{$vo.typename}
            </volist> 
        </td>
        </tr>
      </table>
