...
<div class="wrap J_check_wrap">
  <form name="myform" id="myform" action="{:U("Admin/Product/category_add")}" method="post" class="J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
    ...
    <div class="table_full">
      <table width="100%">
      	<tr><td>分类名称</td><td><input type="text" name="c_name"></td></tr>
