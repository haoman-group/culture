...
<body class="J_scroll_fixed">
  ...
  <div class="prompt_text">
    <p>{$path}</p>
        ...
        <form action="{:U('ArtCategory/edit')}" method="post">
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    <volist name="data" id="vo">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="input" name="cid" id="cid" size="20" value="{$vo.cid}" readonly="readonly"></input>
                            </td>
                        </tr>
                        <tr>
                            <th width="147">父类目CID：</th>
                            <td>
                                <input type="text" class="input" name="parent_cid" id="parent_cid" size="20" value="{$vo.parent_cid}" readonly="readonly"></input>
                            </td>
                        </tr>
                        <tr>
                            <th width="147">名称：</th>
                        ...
                        <tr>
                            <th width="147">简介：</th>
                            <td>
                                <textarea type="text" class="input_txt" name="description" >{$vo.description}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <th width="147">图片：</th>
