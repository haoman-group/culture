...
<div class="wrap">
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <!-- 文化惠民 -->
            <form class="J_ajaxForm" action="{:U('activeadd')}" method="post" data-cid="202" hidden>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="explain">
                                <li>文件上传:</li>
                                <li>
                                    <a href="javascript:upfile('active_picture')" class="seller_upload_image">上传封面</a>
            ...
            <!-- 群文赛事->群星奖 -->
            <form class="J_ajaxForm" action="{:U('activeadd')}" method="post" data-cid="205" hidden>
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="explain">
                                <li>文件上传:</li>
                                <li>
                                    <a href="javascript:upfile('stars_picture')" class="seller_upload_image">上传封面</a>
                                    <p class="tips">提示：1、封面上传大小不得超过4M</p>
                                    <p class="tips">2、本类目下您最多可以上传{$maxPicNum}张封面</p>
                                </li>
                            </ul>
                            <ul class="img jsaddimgul" id="stars_picture">
                                <for start="0" end="$maxPicNum">
                                    <if condition="$picture_urls[$i] neq ''">
                                        <li class=''>
                                            <input type="hidden" name="stars_picture_url[]" value="{$picture_urls[$i]}">
                                            <img src="{$picture_urls[$i]}">
                                            <div class="operate"><span class="sl"></span><span class="sr"></span><a
                                                    href="javascript:void(0)" class="tupian"></a></div>
                                        </li>
            ...
            <form class="J_ajaxForm" action="{:U('activeadd')}" method="post" data-cid="206" hidden>
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                        ...
                        <td>
                            ...
                            <ul class="img jsaddimgul" id="more_picture">
                                <for start="0" end="$maxPicNum">
                                    <if condition="$picture_urls[$i] neq ''">
                                        <li class=''>
                                            <input type="hidden" name="more_picture_url[]" value="{$picture_urls[$i]}">
                                            <img src="{$picture_urls[$i]}">
                                            <div class="operate"><span class="sl"></span><span class="sr"></span><a
                                                    href="javascript:void(0)" class="tupian"></a></div>
                                        </li>
            ...
            <!-- 品牌活动 省级 -->
            <form class="J_ajaxForm" action="{:U('activeadd')}" method="post" data-cid="207" hidden>
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        <th>详情：</th>
                        <td>
                            <script type="text/plain" id="publish_content5" name="publish_content"></script>
            ...
            <!-- 市级 -->
            <form class="J_ajaxForm" action="{:U('activeadd')}" method="post" data-cid="208" hidden>
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                        ...
                        <td>
                            ...
                            <ul class="img jsaddimgul" id="shiji_picture">
                                <for start="0" end="$maxPicNum">
                                    <if condition="$picture_urls[$i] neq ''">
                                        <li class=''>
                                            <input type="hidden" name="shiji_picture_url[]" value="{$picture_urls[$i]}">
                                            <img src="{$picture_urls[$i]}">
                                            <div class="operate"><span class="sl"></span><span class="sr"></span><a
                                                    href="javascript:void(0)" class="tupian"></a></div>
                                        </li>
                    ...
                    <tr>
                        <th>详情:</th>
                        <td>
                            <script type="text/plain" id="publish_content6" name="publish_content"></script>
