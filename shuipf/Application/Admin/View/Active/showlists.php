...
<div class="wrap">
    ...
    <div class="nav">
        <ul class="cc">
            <li class="current"><a href="">文化展览</a></li>
            <li><a class="lib_add" href="{:U('showadd')}">添加</a></li>
        </ul>
    </div>
        ...
        <table width="100%" cellspacing="0">
            ...
            <volist name="data" id="vo">
                <tr>
                    ...
                    <td align="center"><a href="{:U('Admin/Active/showedit', array('id'=>$vo['id']))}">[修改]</a>&nbsp;|&nbsp;<a
                            href="{:U('Admin/Active/showdelete', array('id'=>$vo['id']))}">[删除]</a></td>
                </tr>
            </volist>
            </tbody>
        </table>
