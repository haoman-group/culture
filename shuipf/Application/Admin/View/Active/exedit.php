...
<div class="wrap jj">
 ...
 <div class="nav">
  ...
  <div class="common-form table_full">
    <form  class="J_ajaxForm" method="post"  action="{:U('exedit')}">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <select name="art_cid" id="active_type">
                    <volist name="active_type" id="vo">
                        <option value="{$vo.cid}" <if condition="$vo['cid'] eq $data['art_cid']" >selected</if>>{$vo.name}</option>
                    </volist>
                </select>
              </td>
            </tr>
             <tr  name="selectshow">
                      ...
                      <td><input type="text" name="areaname" value="{$data['areaname']}" disabled="disabled"></td>
                    </tr>
            <tr id="term_type" <empty name="data['type']">hidden</empty>>
              <th width="147">团体类型:</th>
              <td>
                <select name="type" id="typeId" <noempty name="data['type']" >disabled</noempty>disabled>
                    <option value="1" <if condition="$data['type'] eq 1" >selected</if>>官办团体</option>
                    <option value="2" <if condition="$data['type'] eq 2" >selected</if>>社会团体</option>
                </select>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
              <script type="text/plain" id="publish_content" name="abstract">{$data.abstract}</script>
            ...
            <tr>
              <th width="147">时间:</th>
              <td><input type="text" class="input length_2 J_date date" name="act_time" id="controller" value="{$data.act_time}" placeholder="" required="required"/></td>
            </tr>
            <tr>
              <th width="147">地点:</th>
  ...
  <div class="table_list" id="typecategory">
                    <a href="{:U('Active/content',array('parent_id'=>$data['id']))}">添加</a>
