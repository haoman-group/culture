...
<div class="wrap">
    <div class="nav">
        <ul class="cc">
            <li><a href="{:U('showlists')}">文化展览</a></li>
        </ul>
    </div>
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <!-- 图书馆->展览预告 -->
            <if condition="$data['art_cid'] eq 199">
                <form class="J_ajaxForm" action="{:U('showedit')}" method="post" data-cid="199">
                    <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                    <input type="hidden" name="art_cid" value="199">
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="explain">
                                    <li>文件上传:</li>
                                    <li>
                                        <a href="javascript:upfile('acrobatics_picture')" class="seller_upload_image">上传封面</a>
            ...
            <!-- 文化馆->展览预告 -->
            <if condition="$data['art_cid'] eq 200">
                <form class="J_ajaxForm" action="{:U('showedit')}" method="post" data-cid="200">
                    <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                    <input type="hidden" name="art_cid" value="200">
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="explain">
                                    <li>文件上传:</li>
                                    <li>
                                        <a href="javascript:upfile('handwriting_picture')" class="seller_upload_image">上传封面</a>
                                        <p class="tips">提示：1、封面上传大小不得超过4M</p>
                                        <p class="tips">2、本类目下您最多可以上传{$maxPicNum}张封面</p>
                                    </li>
                                </ul>
            ...
            <!--文化馆->展览现场-->
            <if condition="$data['art_cid'] eq 201">
                <form class="J_ajaxForm" action="{:U('showedit')}" method="post" data-cid="201">
                    <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                    <input type="hidden" name="art_cid" value="201">
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="explain">
                                    <li>文件上传:</li>
                                    <li>
                                        <a href="javascript:upfile('exhibition_picture')" class="seller_upload_image">上传封面</a>
                                        <p class="tips">提示：1、封面上传大小不得超过4M</p>
                                        <p class="tips">2、本类目下您最多可以上传{$maxPicNum}张封面</p>
                                    </li>
                                </ul>
                                        ...
                                        <if condition="$picture_urls[$i] neq ''">
                                            <li class=''>
                                                <input type="hidden" name="exhibition_picture_url[]"
                                                       value="{$picture_urls[$i]}">
                                                <img src="{$picture_urls[$i]}">
                                                <div class="operate"><span class="sl"></span><span class="sr">{$data.publish_content}</span><a
                                                        href="javascript:void(0)" class="tupian"></a></div>
                                            </li>
                                            <else/>
                                            <li class="noimg"></li>
