...
<div class="wrap">
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <form class="J_ajaxForm" action="{:U('add')}" method="post" data-cid="189" hidden>
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="explain">
                                <li>文件上传:</li>
                                <li>
                                    <a href="javascript:upfile('drama_picture')" class="seller_upload_image">上传封面</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="input" required name="contacts_tel" size="20"
            ...
            <!-- 老人大学 -->
            <form class="J_ajaxForm" action="{:U('add')}" method="post" style="display:none" data-cid="193">
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                        ...
                        <td>
                            <ul class="explain">
                                ...
                                <li>
                                    ...
                                    <a href="javascript:upfile('music_picture')" class="seller_upload_image">上传封面</a>
                                    <p class="tips">提示：1、封面上传大小不得超过4M</p>
                                    <p class="tips">2、本类目下您最多可以上传{$maxPicNum}张封面</p>
                                </li>
                            </ul>
                    ...
                    <tr>
                        ...
                        <td>
                            <script type="text/plain" id="publish_content2" name="publish_ordermessage"></script>
                    ...
                    <tr>
                        ...
                        <td>
                            <script type="text/plain" id="publish_content3" name="publish_ordersetup"></script>
                    ...
                    <tr>
                        ...
                        <td>
                            <script type="text/plain" id="publish_content4" name="publish_orderintroduce"></script>
            ...
            <!-- 少儿培训 -->
            <form class="J_ajaxForm" action="{:U('add')}" method="post" style="display:none" data-cid="194">
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                        ...
                        <td>
                            <ul class="explain">
                                ...
                                <li>
                                    ...
                                    <a href="javascript:upfile('dance_picture')" class="seller_upload_image">上传封面</a>
                                    <p class="tips">提示：1、封面上传大小不得超过4M</p>
                                    <p class="tips">2、本类目下您最多可以上传{$maxPicNum}张封面</p>
                                </li>
                            </ul>
                    ...
                    <tr>
                        <th width="147">详情：</th>
                        <td>
                            <script type="text/plain" id="publish_content11" name="publish_content"></script>
                    ...
                    <tr>
                        <th width="147">学期通知：</th>
                        <td>
                            <script type="text/plain" id="publish_content12" name="publish_ordermessage"></script>
                    ...
                    <tr>
                        <th width="147">课程设置：</th>
                        <td>
                            <script type="text/plain" id="publish_content13" name="publish_ordersetup"></script>
                    ...
                    <tr>
                        <th width="147">老师介绍：</th>
                        <td>
                            <script type="text/plain" id="publish_content14" name="publish_orderintroduce"></script>
            ...
            <!-- 基层辅导 -->
            <form class="J_ajaxForm" action="{:U('add')}" method="post" data-cid="195" hidden>
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        <th width="147">详情：</th>
                        <td>
                            <script type="text/plain" id="publish_content15" name="publish_ordersetup"></script>
            ...
            <!-- 群文讲座   -->
            <form class="J_ajaxForm" action="{:U('add')}" method="post" data-cid="196" hidden>
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        <th width="147">详情：</th>
                        <td>
                            <script type="text/plain" id="publish_content16" name="publish_ordersetup"></script>
