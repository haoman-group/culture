...
<div class="wrap">
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <!-- 官办活动 省级-->
            <form class="J_ajaxForm" action="{:U('groupadd')}" method="post" data-cid="211" hidden>
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="explain">
                                <li>文件上传:</li>
                                <li>
                                    <a href="javascript:upfile('group_picture')" class="seller_upload_image">上传封面</a>
                            ...
                            <ul class="img jsaddimgul" id="group_picture">
                                <for start="0" end="$maxPicNum">
                                    <if condition="$picture_urls[$i] neq ''">
                                        <li class=''>
                                            <input type="hidden" name="group_picture_url[]" value="{$picture_urls[$i]}">
                    ...
                    <tr>
                        ...
                        <td>
                            <script type="text/plain" id="publish_abstract" name="abstract"></script>
            ...
            <!-- 官办活动 市级-->
            <form class="J_ajaxForm" action="{:U('groupadd')}" method="post" data-cid="212" hidden>
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                        ...
                        <td>
                            ...
                            <ul class="img jsaddimgul" id="city_picture">
                                <for start="0" end="$maxPicNum">
                                    <if condition="$picture_urls[$i] neq ''">
                                        <li class=''>
                                            <input type="hidden" name="city_picture_url[]" value="{$picture_urls[$i]}">
                                            <img src="{$picture_urls[$i]}">
                                            <div class="operate"><span class="sl"></span><span class="sr"></span><a
                                                    href="javascript:void(0)" class="tupian"></a></div>
                                        </li>
            ...
            <!-- 官办活动 县级 -->
            <form class="J_ajaxForm" action="{:U('groupadd')}" method="post" data-cid="213" hidden>
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                        ...
                        <td>
                            ...
                            <ul class="img jsaddimgul" id="xian_picture">
                                <for start="0" end="$maxPicNum">
                                    <if condition="$picture_urls[$i] neq ''">
                                        <li class=''>
                                            <input type="hidden" name="xian_picture_url[]" value="{$picture_urls[$i]}">
                                            <img src="{$picture_urls[$i]}">
                                            <div class="operate"><span class="sl"></span><span class="sr"></span><a
                                                    href="javascript:void(0)" class="tupian"></a></div>
                                        </li>
                    ...
                    <tr>
                        ...
                        <td>
                            <script type="text/plain" id="publish_abstract" name="publish_abstract"></script>
                            <?php echo Form::editor('publish_abstract', 'basic', 'Cudatabase'); ?>
                        </td>
                    </tr>
                     <!--<tr>
            ...
            <!-- 社会团体 -->
            <form class="J_ajaxForm" action="{:U('groupadd')}" method="post" data-cid="210" hidden>
                <input type="hidden" style="opacity: 0; width: 0px;" name="area" class="area" value="{$data.area}"/>
                <input type="hidden" name="art_cid" value="">
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <td>
                        <dl class="logdata">
                            <dt>经度坐标位置：</dt>
                            <dd><input type="text" name="point_lng" class="input point_lng" value="{$data.point_lng}"
                                       data-lng="{$data.point_lng}"/><span></span></dd>
                            <dt>纬度坐标位置：</dt>
                            <dd><input type="text" name="point_lat" class="input point_lat" value="{$data.point_lat}"
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="explain">
                                <li>文件上传:</li>
                                <li>
                                    <a href="javascript:upfile('shehui_picture')" class="seller_upload_image">上传封面</a>
                                    <p class="tips">提示：1、封面上传大小不得超过4M</p>
                                    <p class="tips">2、本类目下您最多可以上传{$maxPicNum}张封面</p>
                                </li>
                            </ul>
                    ...
                    <tr>
                        <th width="147">详情：</th>
                        <td>
                            <script type="text/plain" id="publish_content3" name="publish_content"></script>
