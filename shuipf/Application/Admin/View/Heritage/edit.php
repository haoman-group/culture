        ...
        <div class="table_full">
            <form class="J_ajaxForm" action="{:U('edit')}" method="post"  >
                ...
                <tr>
                    <th width="147">名称</th>
                    <td>
                        <input type="text" maxlength="45" class="input length_5 " name="title" value="{$data.title}" >
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="level">
                            <option <eq name="data['level']" value="第一批">selected</eq>>第一批</option>
                            <option <eq name="data['level']" value="第二批">selected</eq>>第二批</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="radio" name="position" value="yes" id="position_yes" <if condition="$data['position'] eq 'yes'">checked</if>>
                        <label for="position_yes">是</label>
                        <input type="radio" name="position" value="no"  id="position_no" <if condition="$data['position'] eq 'no'">checked</if>>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <ul class="img jsaddimgul" id="background">
                            <if condition="$data['background'] neq ''">
                                <li class=''>
                                    <input type="hidden" name="background_url[]" value="{$data['background']}">
