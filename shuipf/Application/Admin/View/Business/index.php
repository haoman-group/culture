         ...
         <volist name="data" id="vo">
          <tr>
            ...
            <td>
	            ...
	            <elseif condition="$vo.pass eq 0"/>
	            		<a href="{:U('Business/minute',array('id' => $vo['id']))}">审核</a>
	            <else />
	            		<a href="javascript:;" style="color: red;">审核未通过</a>
            	</if>
            			<a href="{:U('Business/minute',array('id' => $vo['id']))}">查看</a>
            			<a href="{:U('Business/delete',array('id' => $vo['id']))}">删除</a>
            </td>
          </tr>
        </volist>  
      </table>
