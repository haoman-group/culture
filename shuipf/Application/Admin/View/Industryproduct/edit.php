...
<div class="wrap">
    <div class="nav">
        <ul class="cc">
            <li class="current"><a href="{:U('Admin/IndustryProduct/index')}">文化产品展示馆列表</a></li>
        ...
        <div class="table_full">
            <form class="J_ajaxForm" action="{:U('edit')}" method="post"  >
                ...
                <tr>
                    <th width="147">标题</th>
                    <td>
                        <input type="text" maxlength="255" class="input length_5" name="title" value="{$data.title}" required="required">
                    </td>
                </tr>
                <tr>
                    <th width="147">关键字</th>
                    <td>
                        <input type="text" maxlength="255" class="input length_5" name="keyword" value="{$data.keyword}" required="required">
                    </td>
                </tr>
                <tr>
                    <th>封面：</th>
                ...
                <tr>
                    <th width="147">产品展示地址</th>
                    <td>
                        <input type="url" maxlength="255" class="input length_5" name="url" value="{$data.url}" required="required">
                    </td>
                </tr>
