        ...
        <div class="table_full">
            <form class="J_ajaxForm" action="{:U('add')}" method="post"  >
                ...
                <tr>
                    <th width="147">标题</th>
                    <td>
                        <input type="text" maxlength="45" class="input length_5" name="title" value="" required="required">
                    </td>
                </tr>
                <tr>
                    <th width="147">作者</th>
                    <td>
                        <input type="text" maxlength="45" class="input length_5" name="author" value="" >
                    </td>
                </tr>
                <tr>
                    <th width="147">来源</th>
                    <td>
                        <input type="text" maxlength="45" class="input length_5" name="source" value="" >
                    </td>
                </tr>
                <tr>
                    <th width="147">简介</th>
