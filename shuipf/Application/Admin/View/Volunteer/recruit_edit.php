...
<div class="wrap jj">
 ...
 <div class="nav">
    <ul class="cc">
        <li ><a href="{:U('recruit')}">招募</a></li>
        <li class="current"><a href="###">编辑</a></li>
  </ul>
</div>
  <div class="common-form table_full">
    <form  class="J_ajaxForm" method="post"  action="{:U('recruit_edit')}">
      <div class="table_list table_art">
        <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
          <tbody>
            <!--<tr name="selectshow" >
                <th width="147">所属地区：</th>                             
                <td ><select id="area" name="area"  class="select_area" ></select></td>
            </tr>-->
            <tr>
              <th width="147">标题:</th>
              <td>
            ...
            <tr>
              ...
              <textarea name="intro" rows="5" cols="57">{$data.intro}</textarea>
              </td>
            </tr>
            <tr>
              <th width="147">志愿者要求:</th>
              <td><input type="text" class="input" name="condition" id="controller" value="{$data.condition}" placeholder=""></td>
            </tr>
            <tr>
              <th width="147">服务地点:</th>
              <td><input type="text" class="input" name="addr" id="action" value="{$data.addr}"></td>
            </tr>
            <tr>
              <th width="147">服务时间:</th>
