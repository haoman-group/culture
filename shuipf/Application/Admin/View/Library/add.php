        ...
        <ul class="pignose-tab-group">
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container">
                    <form action="{:U('Admin/Library/add')}" method="post" class="J_ajaxForm">
                        <dl class="logdata">
                            
                            <dt>所属地区</dt><dd><select id="area"  class="" ></select></dd>
                           
                            <input type="hidden" name="area" class="area" value="{$data.area}">
                            <dt>名称</dt><dd><input type="text" name="name" value="{$data.name}"></dd>
                            <dt>地址</dt><dd><input type="text" name="addr" value="{$data.addr}"></dd>
                            <dt>馆内布局</dt><dd><input type="text" name="computer_layout" value="{$data.computer_layout}" ></dd>
                             ...
                             <dt>办证须知</dt><dd><input type="text" name="computer_permit" value="{$data.computer_permit}" ></dd>
                            <dt>法人代表</dt><dd><input type="text" name="legal_person" value="{$data.legal_person}"></dd>
                            <dt>联系电话</dt><dd><input type="text" name="telephone" value="{$data.telephone}" /></dd>
                            <dt>馆社建筑面积</dt><dd><input type="text" name="covered_area" value="{$data.covered_area}" /></dd>
                            <dt>占地面积</dt><dd><input type="text" name="floor_area" value="{$data.floor_area}" /></dd>
                            <dt>书库面积</dt><dd><input type="text" name="book_area" value="{$data.book_area}" /></dd>
                            <dt>阅览室面积</dt><dd><input type="text" name="readroom_area" value="{$data.readroom_area}" /></dd>
                            <dt>阅览室坐席数</dt><dd><input type="text" name="readroom_seat_num" value="{$data.readroom_seat_num}" /></dd>
                            <dt>少儿阅览坐席数</dt><dd><input type="text" name="chilreadroom_seat_num" value="{$data.chilreadroom_seat_num}" /></dd>
                            <dt>报告厅面积</dt><dd><input type="text" name="reportroom_area" value="{$data.reportroom_area}" /></dd>
                            <dt>报告厅坐席数</dt><dd><input type="text" name="reportroom_seat_num" value="{$data.reportroom_seat_num}" /></dd>
                            <dt>电子阅览室面积</dt><dd><input type="text" name="ereadroom_area" value="{$data.ereadroom_area}" ></dd>
                            <dt>电子阅览室坐席数</dt><dd><input type="text" name="ereadroom_seat_num" value="{$data.ereadroom_seat_num}" /></dd>
                            <dt>计算机总数</dt><dd><input type="text" name="computer_num" value="{$data.computer_num}" ></dd>
                            <dt>供读者使用的计算机数量</dt><dd><input type="text" name="reader_user_num" value="{$data.reader_user_num}" ></dd>
                            <dt>读者服务区是否提供无线网络覆盖</dt><dd><input type="radio" id="yes" name="have_wifi"  value=1 <eq name="data.have_wifi" value="1">checked</eq> /><label for="yes">是</label> <input type="radio" id="no" name="have_wifi"  value=2 <eq name="data.have_wifi" value="2">checked</eq> /><label for="no">否</label></dd>
                            <dt>计算机信息节点</dt><dd><input type="text" name="computer_info_node" value="{$data.computer_info_node}"></dd>
                            <dt>宽带接入</dt><dd><input type="text" name="bandwidth" value="{$data.bandwidth}" /><span>（Mbps）</span></dd>
            ...
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container">
                    <form action="{:U('Admin/Library/add')}" method="post"  name="myform" class="J_ajaxForm">
                        <input type="hidden" name="area" class="area" value="{$data.area}">
                        <dl class="logdata">
                            <dt>总藏量</dt><dd><input type="text" name="num_totle" value="{$data.num_totle}"><span>（万册、件）</span></dd>
                            <dt>电子文献藏量</dt><dd><input type="text" name="num_e_doc" value="{$data.num_e_doc}"><span>（种）</span></dd>
                            <dt>电子图书藏量</dt><dd><input type="text" name="num_e_book" value="{$data.num_e_book}"><span>（种）</span></dd>
                            <dt>电子期刊藏量</dt><dd><input type="text" name="num_e_periodical" value="{$data.num_e_periodical}"><span>（种）</span></dd>
                            <dt>图书年入藏量</dt><dd><input type="text" name="num_collect_book" value="{$data.num_collect_book}"><span>（万种）</span></dd>
                            <dt>报刊年入藏量</dt><dd><input type="text" name="num_collect_periodical" value="{$data.num_collect_periodical}"><span>（种）</span></dd>
                            <dt>试听文献年入藏量</dt><dd><input type="text" name="num_collect_audio" value="{$data.num_collect_audio}"><span>（种）</span></dd>
                            <dt>数字资源总量</dt><dd><input type="text" name="num_digit_totle" value="{$data.num_digit_totle}"><span>（TB）</span></dd>
                            <dt>自建数字资源总量</dt><dd><input type="text" name="num_digit_self" value="{$data.num_digit_self}"><span>（TB）</span></dd>                            
                        </dl>
                        <div class="btn_wrap_pd">  
            ...
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container table_list">
                    <div class="btn-box">
                        <input type="submit" value="添加" class='btn btn_submit btn_add' data-type="addFund" data-idlib="{$data.id}" />
                    </div>
                    <div class="table-box">
                        <table>
                            <thead>
                            ...
                            <volist name="data['Lib_Fund']" id="vo">
                                <tr>
                                    ...
                                    <td>{$vo.fund_free}</td>
                                    <td>{$vo.fund_ele}</td>
                                    <td><a href="###" class="btn_sub_edit" data-type="Fund" data-id="{$vo.id_lib_fund}"  data-idlib="{$data.id}">[修改]</a>&nbsp;|&nbsp;
                                        <a href="{:U('Admin/Library/subDel', array('id'=>$vo['id_lib_fund'],'type'=>'Fund'))}">[删除]</a>
                                    </td>
                                </tr>
                            </volist>
                            </tbody>
            ...
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container table_list">
                    <div class="btn-box">
                        <input type="submit" value="添加" class='btn btn_submit btn_add' data-type="addTalent" data-idlib="{$data.id}" />
                    </div>
                    <div class="table-box">
                        <table>
                            <thead>
                            ...
                            <volist name="data['Lib_Talent']" id="vo">
                                <tr>
                                    ...
                                    <td><a href="###" class="btn_sub_edit" data-type="Talent" data-id="{$vo.id_lib_tal}"  data-idlib="{$data.id}">[修改]</a>&nbsp;|&nbsp;
                                        <a href="{:U('Admin/Library/subDel', array('id'=>$vo['id_lib_tal'],'type'=>'Talent'))}">[删除]</a>
                                    </td>
                                </tr>
                            </volist>
                            </tbody>
            ...
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container">
                    <form action="{:U('Admin/Library/add')}" method="post"  name="myform" class="J_ajaxForm">
                        <dl class="logdata">
                            <dt>基础服务项目</dt><dd><input type="text" name="ser_name" value="{$data.ser_name}" /><span>（项）</span></dd>
                            <dt>每周开馆时间</dt><dd><input type="text" name="ser_hours" value="{$data.ser_hours}" /><span>（小时）</span></dd>
                            <dt>是否错时开放</dt><dd><input type="radio" id="yes" name="ser_interleaved"  value=1 <eq name="data.ser_interleaved" value="1">checked</eq> /><label for="yes">是</label> <input type="radio" id="no" name="ser_interleaved"  value=2 <eq name="data.ser_interleaved" value="2">checked</eq> /><label for="no">否</label></dd>
                            <dt>书看文献年外借册次</dt><dd><input type="text" name="ser_borrow_num" value="{$data.ser_borrow_num}" /><span>（万册次）</span></dd>
                            <dt>年总流通人次</dt><dd><input type="text" name="ser_people_count" value="{$data.ser_people_count}" /><span>（千人次）</span></dd>
                            <dt>流动服务点书刊借阅册次</dt><dd><input type="text" name="ser_nodeborrow_num" value="{$data.ser_nodeborrow_num}" /><span>（千册次）</span></dd>
                            <dt>人均年到馆次数</dt><dd><input type="text" name="ser_avg_visit" value="{$data.ser_avg_visit}" /><span>（年流通总人次/持证读者数量）</span></dd>
                            <dt>无障碍设施</dt><dd><input type="text" name="ser_accessible" value="{$data.ser_accessible}" /><span></span></dd>
                            <dt>盲文图书藏量</dt><dd><input type="text" name="ser_braille_num" value="{$data.ser_braille_num}" /><span>（册）</span></dd>                            
                        </dl>
                        <div class="btn_wrap_pd">  
                            <input type="submit" value="提交" class="btn btn_submit mr10 J_ajax_submit_btn" />
                        </div>
            ...
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container table_list">
                    <div class="btn-box">
                        <input type="submit" value="添加" class='btn btn_submit btn_add' data-type="addServer" data-idlib="{$data.id}" />
                    </div>
                    <div class="table-box">
                        <table>
                            <thead>
                            ...
                            <volist name="data['Lib_Server']" id="vo">
                                <tr>
                                    ...
                                    <td><a href="###" class="btn_sub_edit" data-type="Server" data-id="{$vo.id_lib_ser}"  data-idlib="{$data.id}">[修改]</a>&nbsp;|&nbsp;
                                        <a href="{:U('Admin/Library/subDel', array('id'=>$vo['id_lib_ser'],'type'=>'Server'))}">[删除]</a>
                                    </td>
                                </tr>
                            </volist>
                            </tbody>
                ...
                <div class="pignose-tab-container">
                    <form action="{:U('Admin/Library/add')}" method="post"  name="myform" class="J_ajaxForm">
                        <dl class="logdata">
                            ...
                            <dt>App</dt><dd><input type="text" name="dig_app" value="{$data.dig_app}" /><span></span></dd>
                            <dt>博客</dt><dd><input type="text" name="dig_blog" value="{$data.dig_blog}" /></dd>
                            <dt>微博</dt><dd><input type="text" name="dig_weibo" value="{$data.dig_weibo}" /></dd>
                            <dt>空间</dt><dd><input type="text" name="dig_zone" value="{$data.dig_zone}" /></dd>
                            <dt>社区</dt><dd><input type="text" name="dig_community" value="{$data.dig_community}" /></dd>
                            ...
                            <dt>可远程访问的数字资源</dt><dd><input type="text" name="dig_remote_num" value="{$data.dig_remote_num}" /><span>（TB）</span></dd>
                            <dt>是否建有文化信息资源共享工程站点</dt><dd><input type="radio" name="dig_ifshare"  value=1 <eq name="data.dig_ifshare" value="1">checked</eq> /><label for="yes">是</label> <input type="radio" name="dig_ifshare"  value=2 <eq name="data.dig_ifshare" value="2">checked</eq> /><label for="no">否</label></dd>
                            <dt>文化信息资源共享工程经费投入</dt><dd><input type="text" name="dig_share_fund" value="{$data.dig_share_fund}" /><span>（万元/年）</span></dd>
                            <dt>数字图书馆推广工程经费投入</dt><dd><input type="text" name="dig_expand_fund" value="{$data.dig_expand_fund}" /><span>（万元/年）</span></dd>
                            <dt>公共电子阅览室终端是否统一安装管理软件</dt><dd><input type="radio" name="dig_havemanager"  value=1 <eq name="data.dig_havemanager" value="1">checked</eq> /><label for="yes">是</label> <input type="radio" name="dig_havemanager"  value=2 <eq name="data.dig_havemanager" value="2">checked</eq> /><label for="no">否</label></dd>
                            <dt>公共电子阅览室终端数量</dt><dd><input type="text" name="dig_computer_num" value="{$data.dig_computer_num}" /><span>（台）</span></dd> 
            ...
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container table_list">
                    <div class="btn-box">
                        <input type="submit" value="添加" class='btn btn_submit btn_add' data-type="addEducationAct" data-idlib="{$data.id}" />
                    </div>
                    <div class="table-box">
                        <table>
                            <thead>
                            ...
                            <volist name="data['Lib_EducationAct']" id="vo">
                                <tr>
                                    ...
                                    <td><a href="###" class="btn_sub_edit" data-type="EduAct" data-id="{$vo.id_lib_eact}"  data-idlib="{$data.id}">[修改]</a>&nbsp;|&nbsp;
                                        <a href="{:U('Admin/Library/subDel', array('id'=>$vo['id_lib_eact'],'type'=>'EduAct'))}">[删除]</a>
                                    </td>
                                </tr>
                            </volist>
                            </tbody>
            ...
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container table_list">
                    <div class="btn-box">
                        <input type="submit" value="添加" class='btn btn_submit btn_add' data-type="addVolunteer" data-idlib="{$data.id}" />
                    </div>
                    <div class="table-box">
                        <table>
                            <thead>
                            ...
                            <volist name="data['Lib_Volunteer']" id="vo">
                                <tr>
                                    ...
                                    <td><a href="###" class="btn_sub_edit" data-type="Volunteer" data-id="{$vo.id_lib_vol}"  data-idlib="{$data.id}">[修改]</a>&nbsp;|&nbsp;
                                        <a href="{:U('Admin/Library/subDel', array('id'=>$vo['id_lib_vol'],'type'=>'Volunteer'))}">[删除]</a>
                                    </td>
                                </tr>
                            </volist>
                            </tbody>
            ...
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container table_list">
                    <div class="btn-box">
                        <input type="submit" value="添加" class='btn btn_submit btn_add' data-type="addVolunteerAct" data-idlib="{$data.id}" />
                    </div>
                    <div class="table-box">
                        <table>
                            <thead>
                            ...
                            <volist name="data['Lib_VolunteerAct']" id="vo">
                                <tr>
                                    ...
                                    <td><a href="###" class="btn_sub_edit" data-type="VolunteerAct" data-id="{$vo.id_lib_vact}"  data-idlib="{$data.id}">[修改]</a>&nbsp;|&nbsp;
                                        <a href="{:U('Admin/Library/subDel', array('id'=>$vo['id_lib_vact'],'type'=>'VolunteerAct'))}">[删除]</a>
                                    </td>
                                </tr>
                            </volist>
                            </tbody>
            ...
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container table_list">
                    <div class="btn-box">
                        <input type="submit" value="添加" class='btn btn_submit btn_add' data-type="addCommend" data-idlib="{$data.id}" />
                    </div>
                    <div class="table-box">
                        <table>
                            <thead>
                            ...
                            <volist name="data['Lib_Commend']" id="vo">
                                <tr>
                                    ...
                                    <td>{$vo.comm_type}</td>
                                    <td>{$vo.comm_date}</td>
                                    <td><a href="###" class="btn_sub_edit" data-type="Commend" data-id="{$vo.id_lib_comm}"  data-idlib="{$data.id}">[修改]</a>&nbsp;|&nbsp;
                                        <a href="{:U('Admin/Library/subDel', array('id'=>$vo['id_lib_comm'],'type'=>'Commend'))}">[删除]</a>
                                    </td>
                                </tr>
                            </volist>
                            </tbody>
            ...
            <li class="pignose-tab-list">
                ...
                <div class="pignose-tab-container">
                    <form action="{:U('Admin/Library/add')}" method="post"  name="myform" class="J_ajaxForm">
                        <dl class="logdata">
                            <dt>古籍数量</dt><dd><input type="text" name="anc_totle" value="{$data.anc_totle}" /><span></span></dd>
                            <dt>经费投入每周开馆时间</dt><dd><input type="text" name="anc_fund" value="{$data.anc_fund}" /><span></span></dd>
                            <dt>古籍保护宣传活动次数</dt><dd><input type="text" name="anc_activity_num" value="{$data.anc_activity_num}" /><span></span></dd>                              
                        </dl>
                        <div class="btn_wrap_pd">  
                            <input type="submit" value="提交" class="btn btn_submit mr10 J_ajax_submit_btn" />
                        </div>
