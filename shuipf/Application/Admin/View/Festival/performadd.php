...
<div class="wrap">
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <form class="J_ajaxForm" action="{:U('Festival/performadd')}" method="post" >
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        <th>活动时间：</th>
                        <td>
                            <input type="date" name="start_date" value="{$data['start_date']}" class="input J_date date"> - <input type="date" name="end_date" value="{$data['end_date']}" class="input J_date date">
                        </td>
                    </tr>
                    <tr>
                        <th>活动地点：</th>
                        <td>
                            ...
                            <select name="site">
                            <option value="">请选择</option>
                            <option value="山西大剧院">山西大剧院</option>
                            <option value="青年宫演艺中心">青年宫演艺中心</option>
                            <option value="星光剧场">星光剧场</option>
                            <option value="太原工人文化宫">太原工人文化宫</option>
                            <option value="山西大剧院小剧场">山西大剧院小剧场</option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>添加到精品推荐：</th>
                        <td>
                            <input type="radio" name="position" value="yes"><label for="">是</label>  
                            <input type="radio" name="position" value="no"  checked="true"> <label for="">否</label>
                        </td>
                    </tr>
                </table>
                <div class="">
