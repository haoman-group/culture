...
<div class="wrap">
    ...
    <div class="table_list table_art">
        <div class="table_full">
            <form class="J_ajaxForm" action="{:U('Festival/liveadd')}" method="post" >
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        <th>直播链接地址：</th>
                        <td>
                            <input type="text" class="input" name="url"  size="80">
                        </td>
                    </tr>
                    <tr>
                        <th width="147">直播时间：</th>
                        <td>
                        <input type="text" class="input J_datetime date" name="periodical_date" value="" >
                        </td>
                    </tr>
                    <tr>
                        <th>封面：</th>
