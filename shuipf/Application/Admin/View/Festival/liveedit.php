...
<div class="wrap">
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <form class="J_ajaxForm" action="{:U('Festival/liveedit')}" method="post" >
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        <th width="147">直播时间：</th>
                        <td>
                        <input type="text" class="input J_date date" name="periodical_date" value="{$data.periodical_date}" >
                        </td>
                    </tr>
                       <tr>
                        <th>封面：</th>
                        ...
                        <td>
                            ...
                            <ul class="img jsaddimgul" id="image">
                                <if condition="$data['image'] neq ''">
                                        <li class=''>
                                            <input type="hidden" name="images_url[]" value="{$data.image}">
                                            <img src="{$data.image}">
                            ...
                            <ul id="music_video">
                                <for start="0" end="$maxVideoNum">
                                    <if condition="$data['voide'] neq ''">
                                        <li><input type="text" class="input" name="music_video[]" size="20" value="{$data['voide']}" hidden/></li>
                                        <li><input type="text" class="input input-video" name="music_video_title[]" size="60" value="{$data['source']}" readonly='readonly'/><span>审核中...</span>
                                        </li>
                                    </if>
                                </for>
                            </ul>
