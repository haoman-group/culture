...
<div class="wrap">
    <div class="nav">
        <ul class="cc">
            <li><a href="{:U('perform')}">表演类活动</a></li>
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <form class="J_ajaxForm" action="{:U('Festival/performedit')}" method="post" >
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="site">
                            <option value="">请选择</option>
                            <option value="山西大剧院" <if condition="$data['site'] eq '山西大剧院' "> selected="selected" </if>>山西大剧院</option>
                            <option value="青年宫演艺中心" <if condition="$data['site'] eq '青年宫演艺中心' "> selected="selected" </if> >青年宫演艺中心</option>
                            <option value="星光剧场" <if condition="$data['site'] eq '星光剧场' "> selected="selected" </if> >星光剧场</option>
                            <option value="太原工人文化宫" <if condition="$data['site'] eq '太原工人文化宫' "> selected="selected" </if>>太原工人文化宫</option>
                            <option value="山西大剧院小剧场" <if condition="$data['site'] eq '山西大剧院小剧场' "> selected="selected" </if>>山西大剧院小剧场</option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>主标题:</th>
                        <td><input type="text" class="input" name="title" value="{$data.title}">
                        <input type="hidden" class="input" name="id" value="{$data['id']}">
                        </td>
                    </tr>
                    <tr>
                        <th>副标题:</th>
                        <td><input type="text" class="input" name="deputy_title" value="{$data.deputy_title}"></td>
                    </tr>
                    <tr>
                                ...
                                <for start="0" end="$maxVideoNum">
                                    <if condition="$data['voide'] neq ''">
                                        <li><input type="text" class="input" name="music_video[]" size="20"
                                                   value="{$data['voide']}" hidden/></li>
                                        <li><input type="text" class="input input-video" name="music_video_title[]"
                                                   size="60" value="{$data['source']}" readonly='readonly'/><span>审核中...</span>
                                        </li>
                                    </if>
                                </for>
                            </ul>
