...
<div class="wrap">
    ...
    <ul class="cc" style="width:100%">
        ...
        <li class="adminbtnbox">
          ...
          <a class="lib_add" href="{:U('exhibitionadd')}">添加</a></li>
    </ul>
    </div>
    ...
    <div class="table_list">
        <div class="table_full">
            <form class="J_ajaxForm" action="{:U('exhibition')}" method="get">
            <input type="hidden" name="g" value="Admin">
            <input type="hidden" name="m" value="Festival">
            <input type="hidden" name="a" value="exhibition">
            ...
            <table cellpadding="2" cellspacing="1" class="table_form" width="">
                <tr>
                    ...
                    <td>
                      ...
                      <a style="" href="{:U('exhibition')}" class="btn">清除条件</a>
                    </td>
                </tr>
            </table>
            </form>
          ...
          <volist name="data" id="vo">
            <tr>
             <td  align="center" width="20"><input type="checkbox" name="if_position[]" value="{$vo.id}" class="J_check_all" data-direction="x" data-checklist="J_check_x" ></td>
              ...
              <td align="center"><a href="{:U('Admin/Festival/exhibitionedit', array('id'=>$vo['id']))}">[修改]</a>&nbsp;|&nbsp;<a href="{:U('Admin/Festival/exhibitiondelete', array('id'=>$vo['id']))}">[删除]</a></td>
            </tr>
          </volist>
        </tbody>
      </table>
