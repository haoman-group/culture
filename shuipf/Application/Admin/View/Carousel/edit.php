...
<div class="wrap">
    <div class="nav">
        <ul class="cc">
            <li class="current"><a href="{:U('admin/Carousel/show',['area'=>$_GET['area']])}">轮播展示</a></li>
    ...
    <div class="table_list table_art">
        <div class="table_full">
            <form class="J_ajaxForm" action="{:U('edit')}" method="post"  >
                        ...
                        <td>
                            ...
                            <ul class="img jsaddimgul" id="image">
                                <for start="0" end="$maxPicNum">
                                    <if condition="$data['pub_slide'][$_GET['title']-1]['pub_slide'] neq ''">
                                        <li class=''>
                                            <input type="hidden" name="image_url[]" value="{$data['pub_slide'][$_GET['title']-1]['pub_slide']}">
                                            <img src="{$data['pub_slide'][$_GET['title']-1]['pub_slide']}">
                ...
                <tr>
                    <th width="147">轮播链接-PC端(Web)</th>
                    <td>
                        <input type="text" maxlength="255" class="input length_5" name="picture_url" value="{$data['pub_slide'][$_GET['title']-1]['picture_url']}" >
                        
                        
                    </td>
                </tr>
                <tr>
                    <th width="147">轮播链接-手机端(H5)</th>
                    <td>
                        <input type="text" maxlength="255" class="input length_5" name="picture_wap_url" value="{$data['pub_slide'][$_GET['title']-1]['picture_wap_url']}" >
                    </td>
                </tr>
                </table>
                <div class="">
                ...
                <input type="hidden" maxlength="255" class="input length_5" name="area" value="{$_GET['area']}" >
