...
.header h1{background-repeat:no-repeat;width:427px;height:78px;line-height:150px;font-size:35px;color:#962626}
...
<div class="wrap">
  <div class="inner">
    <div class="header">
      <h1>{$Config.sitename}后台管理</h1>
    </div>
    <div class="qzone_login clearfix">
      <div class="qzone_cont" id="_pt">
        <li><img src="{$config_siteurl}statics/images/login_bg.png" alt="生活以快乐为基准，爱情以互惠为原则！"></li>
      </div>
      <!-- end qzone_cont -->
...
<div class="footer">
  <div class="inner">
    <div class="copyright clearfix">
      ...
      <p class="copyright_ch"><a href="http://www.shanxihaomankeji.com" target="_blank">晋能信工科技有限公司</a></p>
    </div>
  </div>
</div>
