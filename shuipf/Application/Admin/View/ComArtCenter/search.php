    ...
    <div class="table_list">
        <div class="table_full">
            <form class="J_ajaxForm"  method="get">
                ...
                <input type="hidden" name="m" value="ComArtCenter">
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    <tr>
                        ...
                        <!-- <td width="15"><a class="btn" href="{:U('Admin/ComArtCenter/search')}"  >清除条件</a></td> -->
                    </tr>
                </table>
                <div style="margin: 10px 0 0;">
                    <button class="btn">搜索</button>
                    <a style="margin-left:4px;" href="{:U('Admin/ComArtCenter/search')}" class="btn">清除条件</a>
                </div>
            </form>
        </div>
    </div>
          ...
          <volist name="lists" id="vo">
            <tr>
             <td  align="left" width="20"><input type="checkbox" class="J_check_all" data-direction="x" data-checklist="J_check_x"></td>
              ...
              <td align="left" style="text-align:center">{$vo.cac_area}</td>
              <td align="left" style="text-align:center">{$vo.cac_legalpre}</td>
              <td align="left" style="text-align:center">{$vo.dig_website}</td>
              <td align="left" style="text-align:center">{$vo.cac_tel}</td>
              <td align="left" style="text-align:center"><a href="{:U('Admin/ComArtCenter/show', array('id'=>$vo['id']))}">[查看]</a></td>
            </tr>
          </volist>
        </tbody>
      </table>
