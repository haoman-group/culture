...
<form action="{:U('Admin/ComArtCenter/addTalent')}" method="post"  class="J_ajaxForm">
    <dl class="logdata">
        <dt>姓名</dt><dd><input type="text" name='tal_name' value="{$data.tal_name}" /><span></span></dd>
        ...
        <dt>民族</dt><dd><input type="text" name='tal_nation' value="{$data.tal_nation}" /><span></span></dd>
        ...
        <dt>昵称</dt><dd><input type="text" name='tal_nickname' value="{$data.tal_nickname}" /></dd>
    </dl>
    ...
    <input type="hidden" value="{$data.id_cac_tal}" name="id_cac_tal">
</form>
