            ...
            <form  class="J_ajaxForm"  action="{:U('add')}" method="post"  >
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        <th>上传单位:</th>
                        <td>
                             <input type="text" class="input" name="unit"  size="50" value="{$data.unit}" />
                     ...
                     <tr>
                        <th>地址详情:</th>
                        <td>
                             <input type="input" class="input" name="display_area"  size="50" value="{$data.display_area}" />
