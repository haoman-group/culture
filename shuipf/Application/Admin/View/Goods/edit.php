    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <form class="J_ajaxForm" action="{:U('Admin/Goods/edit')}" method="post" enctype="multipart/form-data" >
                ...
                <tr><th>商品名称</th><td><input type="" name="title" id="" value="{$data.title}" class="input" /></td></tr>
		      	<tr><th>商品价格</th><td><input type="" name="price" id="" value="{$data.price}"  class="input"/><p>(填写不同价格请用“/”逗号隔开)</p></td></tr>
		      	<tr><th>演员列表</th><td><input type="" name="person" id="" value="{$data.person}"  class="input"/><p>(填写不同演员请用“/”逗号隔开)</p></td></tr>
		      	<tr><th>演出场馆</th><td><input type="" name="address" id="" value="{$data.address}" class="input" /></td></tr>
		      	<tr><th>联系电话</th><td><input type="" name="tel" id="" value="{$data.tel}"  class="input"/></td></tr>
		      	<tr><th>演出时间</th><td><input type="" name="time" id="" value="{$data.time}" class="input" /><p>请以“1990-12-15 周六 19:30”的格式填写，添加多个请用中文格式下“/”逗号隔开</p></td></tr>
		      	<tr><th>商品简介</th><td><input type="text" name="content" id="" value="{$data.content}" class="input" /></td></tr>
		      	<tr><th>商品状态</th><td>
		      		<select name="status">
