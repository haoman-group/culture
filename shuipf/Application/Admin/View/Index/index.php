...
<div class="wrap">
  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head cu-head">
      <th><a href="{:U('Index/index')}" class="logo" style="margin-left:170px">文化云管理系统</a></th>
      <td>
        <div class="nav">
        ...
        <div class="login_info"><span class="mr10">{$role_name}： {$userInfo.username},</span><span class="mr10">所在地区:{$userInfo.area_display}</span><a href="{:U('Public/logout')}" class="mr10" style="color:#114775">[注销]</a>{:tag("view_admin_top_menu")}<a href="{$Config.siteurl}" class="home" target="_blank" style="color:#FFF">前台首页</a><?php if(\Libs\System\RBAC::authenticate('Admin/Index/cache')){ ?><a href="javascript:;;" id="deletecache" class="home"  style="color:#FFF">缓存更新</a><?php } ?></div></td>
    </tr>
    <tr class="tab">
      <!-- <th> <div class="search">
        ...
        <th style="background: #0F4F7D;height: 29px;border-top: 1px solid #03395f;"> </th>
      <td style="background-color:#f3eeee"><div id="B_tabA" class="tabA" > <a href="" tabindex="-1" class="tabA_pre" id="J_prev" title="上一页" ><i  class="fa fa-angle-left" style="margin-top:6px;color:#962626;margin-left:6px"></i></a> <a href="" tabindex="-1" class="tabA_next" id="J_next" title="下一页"><i class="fa fa-angle-right" style="margin-top:6px; color:#962626;"></i></a>
    ...
    <tr class="content cu-content">
      <th>
        <img class="main-menu" style="width:100% ;margin-top:-30px" src="/statics/images/leftmeun.gif" alt="主菜单">
        <div id="B_menunav" class="bcu_menunav">
          <div class="menubar">
            <ul class="M_menunav">
                <li>常用</li>                
            </ul>
      ...
      <td id="B_frame">
        <div class="options"> <a href="" class="refresh" id="J_refresh" title="刷新" ><i class="fa fa-refresh"></i></a> <a href="" id="J_fullScreen" class="full_screen" title="全屏" ><i class="fa fa-arrows"></i></a> </div>
    ...
    <tr><td class="footer" colspan="2">技术支持：晋能信工科技有限公司</td></tr>
  </table>
</div>
<Admintemplate file="Admin/Common/Js"/>
<script src="{$config_siteurl}statics/js/common.js"></script>
<script src="{$config_siteurl}statics/js/jquery.nicescroll.js"></script>
<literal>
<script>
...
function iframe_height(){
	def_iframe_height = $("body").height() - $("#B_history").height() - $(".head th").height() - $(".footer").height();
	$("#B_frame").height(def_iframe_height).prev("th").height(def_iframe_height);
    var height = ($("body").height() - $(".main-menu").height() - 170) + 'px';
    $(".M_menunav").css("height",height);
}
...
$(function () {
    ...
    $.each(SUBMENU_CONFIG, function (i, o) {
        ...
        // console.log(i);
        htmls = [];
        show_left_menu(o.items);
        html.push('<li><a class="left_nav fa fa-angle-right" href="" title="' + o.name + '" data-id="' + o.id + '"><i class="left_nav fa fa-desktop" style=" font-size:10px;height:30px"></i><b>' + o.name + '</b></a></li><dl style="display:none;" class="B_menubar" data-id="'+i+'">'+htmls.join('')+'</dl>');

    });
    $('.M_menunav').html(html.join(''));
    //后台位在第一个导航
    $('.M_menunav li:first > a').click();
    //维持在线
        ...
        for (var attr in data) {
            if (data[attr] && typeof (data[attr]) === 'object') {
                ...
                if (attr === 'name') {
                    ...
                    if (!(data['isChild'])) {
                        //一级菜单
                        htmls.push('<dt><a href="' + data.url + '" data-id="' + data.id + '"><b>' + data.name + '</b></a></dt>');
                    } else {
                        //二级菜单
                        ...
                        if (data.child_index == child_index) {
                            htmls[htmls.length-1] = htmls[htmls.length-1].replace("<dt>","<dt class='arrow'>");
                            htmls.push('<dd style="display: none; "><ul>' + child_html.join('') + '</ul></dd>');
                            child_html = [];
                        }
                    }
                }
    ...
    $(".arrow").find("a").addClass("fa fa-angle-right");
});

// 一级菜单点击
$('.M_menunav').on('click', '.left_nav', function (e) {
    //取消事件的默认动作
    e.preventDefault();
    //终止事件 不再派发事件
    e.stopPropagation();
    var flag = $(this).parent().next("dl").is(":visible");
    $(this).parent().next("dl").slideToggle("slow").siblings("dl").hide().prev("li").find("a").addClass("fa-angle-right").removeClass("fa-angle-down");
    if(flag){
...
//一级导航点击
// $('.M_menunav').on('click', 'a', function (e) {
//     //取消事件的默认动作
//     e.preventDefault();
//     //终止事件 不再派发事件
//     e.stopPropagation();
...
$(function(){
    $('.B_menubar').on('click', 'a', function (e) {
        ...
        //子菜单显示&隐藏
        var flag = _dd.is(":visible");
        if (_dd.length) {
            _dt.toggleClass('current');
            _dd.slideToggle("slow");

            if(flag){
                _dt.find("a").addClass("fa-angle-right").removeClass("fa-angle-down");       
            }else{
                _dt.find("a").addClass("fa-angle-down").removeClass("fa-angle-right");
            }
            //检查上下分页
            checkMenuNext();
            return false;
...
function iframeJudge(options) {
    ...
    if (li.length > 0) {
        ...
        $(iframe[0].contentWindow.document).ready(function () {
            ...
            var li = $('<li tabindex="0"><span><a>' + elem.html() + '</a><a class="del" title="关闭此页"><i class="fa fa-close"></i></a></span></li>').attr('data-id', id).addClass('current');
