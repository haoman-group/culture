...
<div class="wrap">
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <form  action="{:U('groomedit')}" method="post"  >
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                     ...
                     <tr>
                        <th>上映时间:</th>
                        <td>
                             <input type="date" class="input length_2 J_date date" name="scree_time"  size="50" value="{$data.scree_time}" />
                   ...
                   <tr>
                        <th>链接：</th>
                        <td>
                            <input type="input" class="input" name="url"  size="50" value="{$data.url}" />
                        </td>
                    <tr>
                        <th>图片：</th>
                        <td>
