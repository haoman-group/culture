...
<div class="wrap">
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <form  action="{:U('policyedit')}" method="post"  >
                ...
                <tr name="selectshow" >
                    ...
                    <tr>
                        ...
                        <td>
                             <input type="text" class="input" name="title"  size="50" value="{$data.title}" />
                              ...
                              <input type="hidden"  name="id" class="input" size="50" value="{$data.id}"/> 
                    ...
                    <tr>
                        <th>关键字:</th>
                        <td>
                             <input type="text" class="keywords" name="title"  size="50" value="{$data.keywords}" />
                    ...
                    <tr>
                        <th>内容：</th>
                        <td>
                            <script type="text/plain" id="publish_content" name="publish_content">{$news.publish_content}</script>
