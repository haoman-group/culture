...
<div class="wrap">
    ...
    <ul class="cc" style="width:100%">
        <li class="current"><a href="###">最新推荐</a></li>
        ...
        <li class="adminbtnbox">
          ...
          <a class="lib_add" href="{:U('groomadd')}">添加</a></li>
    </ul>
    </div>
          ...
          <volist name="data" id="vo">
            <tr>
             <td  align="center" width="20"><input type="checkbox" class="J_check_all" data-direction="x" data-checklist="J_check_x"></td>
              ...
              <td align="center">{$vo['scree_time']}</td>
              <td align="center">{$vo.url}</td>
              <td align="center"><a href="{:U('Admin/Content/groomedit', array('id'=>$vo['id']))}">[修改]</a>&nbsp;|&nbsp;<a href="{:U('Admin/Content/groomdelete', array('id'=>$vo['id']))}">[删除]</a></td>
            </tr>
          </volist>
        </tbody>
      </table>
