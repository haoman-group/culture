...
<div class="wrap">
    <div class="nav">
        <ul class="cc">
            <li><a href="{:U('winchance')}">文创精品</a></li>
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <form class="J_ajaxForm" action="{:U('winchanceedit')}" method="post" data-cid="7" >
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" class="input" name="id"  size="50" value="{$data.id}" />
                     ...
                     <tr>
                        ...
                        <td>
                            ...
                            <input type="text" class="input" name="keyword"  size="50" value="{$data.keyword}" />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" class="input" name="url"  size="50" value="{$data.url}" />
                        ...
                        <td>
                            <ul class="explain">
                                ...
                                <li>
                                    ...
                                    <p class="tips" style="color:red;">上传图片宽：323px; 高:401px;</p>
                                </li>
                            </ul>
                            <ul class="img jsaddimgul" id="drama_picture">
                                <for start="0" end="1">
                                    <if condition="$picture_urls[$i] neq ''">
                                        <li class='' style="width:323px;height:401px;">
                                            <input type="hidden" name="drama_picture_url[]" value="{$picture_urls[$i]}">
                                            <img src="{$picture_urls[$i]}" style="width:323px;height:401px;">
                   ...
                   <tr>
                        ...
                        <td>
                           <select name="is_show">
                            ...
                            <option value="1" <if condition="$data['is_show'] eq 1 "> selected="selected" </if>>是</option>
                            <option value="2" <if condition="$data['is_show'] eq 2 "> selected="selected" </if>>否</option>
