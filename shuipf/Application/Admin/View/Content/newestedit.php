...
<div class="wrap">
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <form class="J_ajaxForm" action="{:U('newestedit')}" method="post"  >
                ...
                <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
                  <tr>
                    ...
                    <td>
                        ...
                        <option value="{$vo['cid']}" <if condition="$vo['cid'] eq $data['news_id'] ">selected="selected"</if>>{$vo['name']}</option>
                        </volist>
                        </select>
                    </td>
                </tr>
                <tr>
                    <th>定时发布时间：</th>
                    <td>
                         <input type="text" class="input J_datetime" name="post_time"  size="25" value="{$data.post_time}" placeholder="立即发布"/>
                    </td>
                </tr>
                <tr  name="selectshow">
                            ...
                            <ul id="music_video">
                                <for start="0" end="$maxVideoNum">
                                    <if condition="$data['video'] neq ''">
                                        <li><input type="text" class="input" name="music_video[]" size="20" value="{$data['video']}" hidden/></li>
                                        <li><input type="text" class="input input-video" name="music_video_title[]" size="60" value="{$data['video_title']}" readonly='readonly'/><span>审核中...</span>
                                        </li>
                                    </if>
                                </for>
                            </ul>
