...
<div class="wrap">
    <div class="nav">
        <ul class="cc">
            <li><a href="{:U('industry')}">产业研究</a></li>
    ...
    <div class="table_list table_art">
        <div class="table_full">
            ...
            <form  action="{:U('industryadd')}" method="post"  >
                    ...
                    <tr>
                        ...
                        <td>
                             <input type="text" class="input" name="title"  size="50" value="{$data.title}" />
                              <input type="hidden"  name="username" class="input" size="50" value="{$userInfo.username}"/> 
                     ...
                     <tr>
                        <th>关键字:</th>
                        <td>
                             <input type="text" class="input" name="keywords"  size="50" value="{$data.keywords}" />
