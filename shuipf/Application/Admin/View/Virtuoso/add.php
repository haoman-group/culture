        ...
        <div class="table_full">
            <form class="J_ajaxForm" action="{:U('add')}" method="post"  >
                ...
                <tr>
                    <th width="147">价格</th>
                    <td>
                    <input type="number" class="input" name="price" value="" required="required">
                    </td>
                </tr>
                <tr>
                    <th width="147">作者</th>
                ...
                <tr>
                    <th width="147">库存</th>
                    <td>
                    <input type="number" class="input" name="stock" value="" required="required">
                    </td>
                </tr>
                <!-- <tr>
                    <th width="147">属性</th>
                    <td>
                        <textarea type="text" class="input_txt" name="property" ></textarea>
                    </td>
                </tr> -->
                <tr>
                    <th width="147">状态</th>
