...
class UserModel extends Model {
    ...
    public function getUserInfo($identifier, $password = NULL) {
        ...
        $userInfo['default_area'] =D('Admin/Area')->getFullAreaID($userInfo['area']);
        return $userInfo;
    }
    ...
    public function amendManager($data) {
        ...
        $data['area_display'] = D('Admin/Area')->getFullAreaName($data['area']);
        if ($this->create($data)) {
    ...
    //     // ));
    //      $this->where(array('id' => $data['id']))->setField('password', $this->hashPassword($data['password'], $data['verify']));
