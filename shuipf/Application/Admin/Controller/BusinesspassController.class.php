<?php
	...
	class BusinesspassController extends AdminBase{
...
//			var_dump($this->model);die;
			$count=$this->model->where(array('pass'=>1))->order('id desc')->count();
			$page=$this->page($count,20);
			$data=$this->model->where(array('pass'=>1))->limit($page->firstRow.','.$page->ListRows)->order('id desc')->select();
