...
class AttachmentsController extends Base {
    ...
    public function videoupload() {
        $data= M('Config')->where(array('varname'=>'access_token'))->cache(true)->find();
        $data['value']=json_decode($data['value'],true);
        //var_dump($data);exit;
        $this->assign('access_token',$data['value']['access_token']);
        $this->display(T('Attachment@Attachments/videoupload'));
    }
    ...
    public function audioupload() {
        ...
        $this->display(T('Attachment@Attachments/audioupload'));
    }

    public function audioplay(){
        $audio_path = I('get.audio_path');
        $this->assign("audio_path", $audio_path);
        $this->display(T('Attachment@Attachments/audioplay'));
    }
