...
<head>
    ...
    <meta name="description" content="Audio Play"/>
    <meta name="robots" content="all"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="author" content="zsun"/>
    <link rel="cannical" href="/examples/audio-player-responsive-and-touch-friendly"/>
    <link rel="stylesheet" href="{$config_siteurl}statics/cu/audioplayer/css/_reset.css"/>
    <link rel="stylesheet" href="{$config_siteurl}statics/cu/audioplayer/css/main.css"/>
    <link rel="stylesheet" href="{$config_siteurl}statics/cu/audioplayer/css/css?family=Advent+Pro"/>
    <style>
        html {
            height: 100%;
        }
...
<script src="{$config_siteurl}statics/cu/audioplayer/js/main.js"></script>
<script src="{$config_siteurl}statics/cu/audioplayer/js/audioplayer.js"></script>
