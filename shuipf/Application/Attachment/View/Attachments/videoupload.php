...
<html>
    <head>
        <meta charset="utf-8">
        <title>upload YOUKU VIDEO File</title>
		...
		<script>
			...
			jQuery(document).ready(function(){
                ...
                //iframe
                var param = {client_id:"{:C('YOUKU_CLIENT_ID')}",access_token:"{$access_token}",oauth_opentype:"iframe",oauth_redirect_uri:"http://test.youku.com/youkuupload/oauth_result.html",oauth_state:"",completeCallback:"uploadComplete",categoryCallback:"categoryLoaded"};
				//newWindow
		...
		<div id="youku-upload">
			<div class="container">
				<form class="well form-horizontal" name="video-upload">
					...
					<div id="complete"></div>
					<div id="video-id" style="display:none"></div>
					<div id="video-title" style="display:none"></div>
