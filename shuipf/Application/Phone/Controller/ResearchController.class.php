...
class ResearchController extends Base {
    protected $area = [];
    ...
    public function lists(){
      $catid= I('get.cid',null);
        ...
        $count =  $this->model->where($where)->count();
         ...
         $page->SetPager('sellercenter', '{prev}{liststart}{list}{listend}{next}', array('link' => '/Phone/Research/lists/cid/10/page/*'));
