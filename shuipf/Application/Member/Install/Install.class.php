...
class Install extends InstallBase {
    ...
    public function end() {
        //移动通行证到lib目录下
        ShuipFCMS()->Dir->copyDir($this->path . "Install/Driver/Passport/", PROJECT_PATH . 'Libs/Driver/Passport/');
        ShuipFCMS()->Dir->copyDir($this->path . "Install/Api/", SITE_PATH . 'api/');
