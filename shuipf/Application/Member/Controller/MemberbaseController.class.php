...
class MemberbaseController extends Base {
    ...
    protected function _initialize() {
        ...
        //登陆检测
        $this->check_member();
        $this->assign('member_type',$this->userinfo['type']);
        //============全局模板变量==============
        //会员组数组
    ...
    final public function check_member() {
        ...
        if ($this->userid) {
            ...
            $this->assign("source_page",M('MemberCommon')->where(array('userid'=>service("Passport")->userid))->getField('source_page'));
            return true;
        } else {
            //对待授权登陆的，进行特别处理把！
            ...
            $this->redirect('Pubservice/Index/doLogin');
        }
    }
